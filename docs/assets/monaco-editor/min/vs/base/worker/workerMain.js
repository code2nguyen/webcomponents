...
(function () {
  ...
  !(function (e) {
        ...
        return (
          ...
          (t.prototype._applyPaths = function (t) {
            for (var n, r = 0, i = this.sortedPathsRules.length; r < i; r++)
              if (((n = this.sortedPathsRules[r]), e.Utilities.startsWith(t, n.from))) {
                for (var o = [], s = 0, a = n.to.length; s < a; s++) o.push(n.to[s] + t.substr(n.from.length));
                return o;
              }
            return [t];
          }),
          ...
          (t.prototype.moduleIdToPaths = function (t) {
            if (
              ...
              (this.options.amdModulesPattern instanceof RegExp && !this.options.amdModulesPattern.test(t))
            )
          ...
          return (
            (e.prototype.load = function (e, t, o, s) {
              ...
              if (!this._scriptLoader)
                ...
                } else this._env.isNode ? (this._scriptLoader = new i(this._env)) : (this._scriptLoader = new n());
        ...
        n = (function () {
          ...
          return (
            ...
            (t.prototype.load = function (t, n, r, i) {
              if (/^node\|/.test(n)) {
                var o = t.getConfig().getOptionsLiteral().nodeRequire || e.global.nodeRequire,
                  s = n.split('|'),
                  a = null;
                try {
                  a = o(s[1]);
                ...
                l.setAttribute('async', 'async'),
                  ...
                  this.attachListeners(l, r, i),
                  l.setAttribute('src', n);
                var u = t.getConfig().getOptionsLiteral().cspNonce;
                u && l.setAttribute('nonce', u), document.getElementsByTagName('head')[0].appendChild(l);
              }
            }),
            t
          );
          ...
          return (
              ...
              if (n && !this._didPatchNodeRequire) {
                ...
                i.prototype._compile = function (e, s) {
                  ...
                  try {
                    ...
                    (a = h.slice(0, 16)), (d.cachedData = h.slice(16)), u.record(60, c);
                  } catch (e) {
                    u.record(61, c);
                  }
                  ...
                  return r._handleCachedData(f, l, c, !d.cachedData, t), r._verifyCachedData(f, l, c, a, t), C;
                };
              }
            }),
            (t.prototype.load = function (n, r, i, o) {
              var s = this,
                ...
                l = a.nodeRequire || e.global.nodeRequire,
                u =
                  a.nodeInstrumenter ||
                  function (e) {
                    return e;
                  };
              this._init(l), this._initNodeRequire(l, n);
              var c = n.getRecorder();
              if (/^node\|/.test(r)) {
                var d = r.split('|'),
                  h = null;
                ...
                var f = this._path.normalize(r),
                  g = this._getElectronRendererScriptPathOrUri(f),
                  m = Boolean(a.nodeCachedData),
                  p = m ? this._getCachedDataPath(a.nodeCachedData, r) : void 0;
                this._readSourceAndCachedData(f, p, c, function (e, r, a, l) {
                  if (e) o(e);
                  else {
                    var c;
                    (c =
                      ...
                      (c = u(c, f));
                    var d = { filename: g, cachedData: a },
                      h = s._createAndEvalScript(n, c, d, i, o);
                    s._handleCachedData(h, c, p, m && !a, n), s._verifyCachedData(h, c, p, l, n);
                  }
                });
              }
            }),
            (t.prototype._createAndEvalScript = function (t, n, r, i, o) {
              ...
              return (
                (d.amd = u.amd),
                l.call(e.global, t.getGlobalAMDRequireFunc(), d, r.filename, this._path.dirname(r.filename)),
            ...
            (t.prototype._createAndWriteCachedData = function (e, t, n, r) {
              var i = this,
                ...
                u = function () {
                  setTimeout(function () {
                    l || (l = i._crypto.createHash('md5').update(t, 'utf8').digest());
                      ...
                      (o.length < s
                        ...
                        : ((s = o.length),
                          i._fs.writeFile(n, Buffer.concat([l, o]), function (e) {
                            e && r.getConfig().onError(e), r.getRecorder().record(63, n), u();
                          })));
                  }, o * Math.pow(4, a++));
                };
              u();
                  ...
                  setTimeout(function () {
                    ...
                    r.equals(e) ||
                      (i
                        ...
                        .onError(
                          new Error(
                            "FAILED TO VERIFY CACHED DATA, deleting stale '" + n + "' now, but a RESTART IS REQUIRED"
                          )
                        ),
        ...
        return (
          ...
          (t.prototype.complete = function (n, r, i) {
            ...
            if (o) {
              ...
              (a.phase = 'factory'), (a.moduleId = this.strId), (this.error = a), r.onError(a);
            }
    ...
    e(n[13], r([0, 1]), function (e, t) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.asArray = t.pushToEnd = t.pushToStart = t.arrayInsert = t.range = t.flatten = t.firstOrDefault = t.first = t.firstIndex = t.distinctES6 = t.distinct = t.isNonEmptyArray = t.isFalsyOrEmpty = t.coalesce = t.groupBy = t.mergeSort = t.findFirstInSorted = t.binarySearch = t.equals = t.tail2 = t.tail = void 0),
        ...
        (t.groupBy = function (e, t) {
          const r = [];
          let i = void 0;
          for (const o of n(e.slice(0), t)) i && 0 === t(i[0], o) ? i.push(o) : ((i = [o]), r.push(i));
          return r;
        }),
    ...
    e(n[16], r([0, 1, 4]), function (e, t, n) {
      ...
      function a(e, t) {
        const n = !!(2048 & e),
          r = !!(256 & e);
        return new l(2 === t ? r : n, !!(1024 & e), !!(512 & e), 2 === t ? n : r, 255 & e);
      }
      !(function () {
      ...
      class l {
        ...
        isModifierKey() {
          return (
            0 === this.keyCode || 5 === this.keyCode || 57 === this.keyCode || 6 === this.keyCode || 4 === this.keyCode
          );
        }
        toChord() {
          return new u([this]);
    ...
    e(n[6], r([0, 1, 15]), function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.ImmortalReference = t.MutableDisposable = t.Disposable = t.DisposableStore = t.toDisposable = t.combinedDisposable = t.dispose = t.isDisposable = t.MultiDisposeError = void 0);
      const r = !1,
        i = '__is_disposable_tracked__';
      function o(e) {
        if (r && e && e !== c.None)
          try {
            e[i] = !0;
        ...
        _remove(e) {
          if (e.prev !== n.Undefined && e.next !== n.Undefined) {
            ...
            e.prev === n.Undefined && e.next === n.Undefined
              ...
              : e.prev === n.Undefined && ((this._first = this._first.next), (this._first.prev = n.Undefined));
          this._size -= 1;
        }
        *[Symbol.iterator]() {
          let e = this._first;
        ...
        toArray() {
          const e = [];
          for (let t = this._first; t !== n.Undefined; t = t.next) e.push(t.element);
          return e;
        }
      };
    }),
    e(n[7], r([0, 1, 4, 6, 17]), function (e, t, n, r, i) {
      'use strict';
      var o;
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (function (e) {
          ...
          function o(e, t) {
            return a((n, r = null, i) => e((e) => t(e) && n.call(r, e), null, i));
          }
          function s(e, t, r) {
            let i = r;
              ...
              onFirstListenerAdd() {
                o = e((e) => {
                  u++,
                    ...
                    (a = setTimeout(() => {
                      const e = s;
                      (s = void 0), (a = void 0), (!r || u > 1) && c.fire(e), (u = 0);
                    }, n));
                });
              },
              onLastListenerRemove() {
          ...
          (e.None = () => r.Disposable.None),
            ...
            (e.any = function (...e) {
              return (t, n = null, i) => r.combinedDisposable(...e.map((e) => e((e) => t.call(n, e), null, i)));
            }),
            (e.reduce = s),
            (e.snapshot = a),
            (e.debounce = u),
          ...
          (e.chain = function (e) {
            ...
            (e.fromNodeEventEmitter = function (e, t, n = (e) => e) {
              const r = (...e) => i.fire(n(...e)),
                i = new l({ onFirstListenerAdd: () => e.on(t, r), onLastListenerRemove: () => e.removeListener(t, r) });
              return i.event;
            }),
      ...
      class l {
        constructor(e) {
          (this._disposed = !1),
            (this._options = e),
            (this._leakageMon = s > 0 ? new a(this._options && this._options.leakWarningThreshold) : void 0);
        }
        get event() {
          return (
            this._event ||
              (this._event = (e, t, n) => {
                ...
                return (
                  ...
                  n instanceof r.DisposableStore ? n.add(u) : Array.isArray(n) && n.push(u),
                  u
                );
              }),
            this._event
      ...
      t.PauseableEmitter = class extends l {
        constructor(e) {
          super(e), (this._isPaused = 0), (this._eventQueue = new i.LinkedList()), (this._mergeFn = e && e.merge);
        }
        pause() {
          this._isPaused++;
        }
        resume() {
          if (0 !== this._isPaused && 0 == --this._isPaused)
            if (this._mergeFn) {
              const e = this._eventQueue.toArray();
    ...
    e(n[18], r([0, 1, 7]), function (e, t, n) {
      ...
      !(function (e) {
        (e.isCancellationToken = function (t) {
          ...
          (e.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: r }));
      ...
      class o {
        ...
        get onCancellationRequested() {
          return this._isCancelled ? r : (this._emitter || (this._emitter = new n.Emitter()), this._emitter.event);
        }
        dispose() {
      ...
      t.CancellationTokenSource = class {
        ...
        cancel() {
          this._token ? this._token instanceof o && this._token.cancel() : (this._token = i.Cancelled);
        }
        dispose(e = !1) {
          e && this.cancel(),
    ...
    e(n[3], r([0, 1]), function (e, t) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.isLittleEndian = t.OS = t.setImmediate = t.globals = t.isIOS = t.isWeb = t.isNative = t.isLinux = t.isMacintosh = t.isWindows = void 0);
      let n = !1,
        r = !1,
        i = !1,
        o = !1,
        ...
        if ('object' == typeof process) {
          ...
          if (e)
            try {
              ...
              (l = t.locale), (u = n || 'en'), (c = t._translationsConfigFile);
            } catch (e) {}
          o = !0;
        }
      } else (n = (d = navigator.userAgent).indexOf('Windows') >= 0), (r = d.indexOf('Macintosh') >= 0), (a = (d.indexOf('Macintosh') >= 0 || d.indexOf('iPad') >= 0 || d.indexOf('iPhone') >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0), (i = d.indexOf('Linux') >= 0), (s = !0), (u = l = navigator.language);
      let f = 0;
      r ? (f = 1) : n ? (f = 3) : i && (f = 2),
        (t.isWindows = n),
        (t.isMacintosh = r),
        ...
        (t.isWeb = s),
        (t.isIOS = a);
      const g = 'object' == typeof self ? self : 'object' == typeof global ? global : {};
      (t.globals = g),
    ...
    e(n[20], r([0, 1, 19]), function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      class c extends Error {
        constructor(e, t, n) {
          ...
          super((o += `. Received type ${typeof n}`)), (this.code = 'ERR_INVALID_ARG_TYPE');
        }
      }
      function d(e, t) {
        ...
        for (let d = 0; d <= e.length; ++d) {
          ...
          if (r(c)) {
            if (s === d - 1 || 1 === u);
              ...
              if (i.length < 2 || 2 !== o || i.charCodeAt(i.length - 1) !== a || i.charCodeAt(i.length - 2) !== a) {
                if (i.length > 2) {
                  const e = i.lastIndexOf(n);
                  -1 === e ? ((i = ''), (o = 0)) : (o = (i = i.slice(0, e)).length - 1 - i.lastIndexOf(n)),
                    (s = d),
                    (u = 0);
                  continue;
                }
            ...
            } else i.length > 0 ? (i += `${n}${e.slice(s + 1, d)}`) : (i = e.slice(s + 1, d)), (o = d - s - 1);
            (s = d), (u = 0);
          } else c === a && -1 !== u ? ++u : (u = -1);
        }
        return i;
      ...
      function p(e, t) {
        if (null === t || 'object' != typeof t) throw new c('pathObject', 'Object', t);
      ...
      (t.win32 = {
        resolve(...e) {
          ...
          for (let o = e.length - 1; o >= -1; o--) {
            ...
            if (o >= 0) {
              ...
              0 === t.length
                ...
                : (void 0 === (s = n.env[`=${t}`] || n.cwd()) ||
                    (s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === u)) &&
                  (s = `${t}\\`);
            const a = s.length;
            let l = 0,
              c = '',
            ...
            if (1 === a) h(m) && ((l = 1), (f = !0));
              ...
              g(m) &&
                58 === s.charCodeAt(1) &&
                ((c = s.slice(0, 2)), (l = 2), a > 2 && h(s.charCodeAt(2)) && ((f = !0), (l = 3)));
            if (c.length > 0)
              if (t.length > 0) {
            ...
            if (i) {
              if (t.length > 0) break;
            } else if (((r = `${s.slice(l)}\\${r}`), (i = f), f && t.length > 0)) break;
          }
        ...
        normalize(e) {
          ...
          if (h(o))
            ...
            g(o) &&
              58 === e.charCodeAt(1) &&
              ((n = e.slice(0, 2)), (r = 2), t > 2 && h(e.charCodeAt(2)) && ((i = !0), (r = 3)));
        ...
        isAbsolute(e) {
          ...
          return h(n) || (t > 2 && g(n) && 58 === e.charCodeAt(1) && h(e.charCodeAt(2)));
        },
        join(...e) {
          ...
          for (let t = 0; t < e.length; ++t) {
            const i = e[t];
            d(i, 'path'), i.length > 0 && (void 0 === n ? (n = r = i) : (n += `\\${i}`));
          }
          if (void 0 === n) return '.';
          let i = !0,
            o = 0;
          if ('string' == typeof r && h(r.charCodeAt(0))) {
            ++o;
            const e = r.length;
            e > 1 && h(r.charCodeAt(1)) && (++o, e > 2 && (h(r.charCodeAt(2)) ? ++o : (i = !1)));
          }
          if (i) {
        ...
        relative(e, n) {
          ...
          if (m !== f) {
            ...
            a > f && (e.charCodeAt(o + m) === u ? (g = m) : 2 === m && (g = 3)), -1 === g && (g = 0);
          }
          let p = '';
          for (m = o + g + 1; m <= s; ++m) (m !== s && e.charCodeAt(m) !== u) || (p += 0 === p.length ? '..' : '\\..');
          return (l += g), p.length > 0 ? `${p}${i.slice(l, c)}` : (i.charCodeAt(l) === u && ++l, i.slice(l, c));
        },
        toNamespacedPath(e) {
          ...
          } else if (g(n.charCodeAt(0)) && 58 === n.charCodeAt(1) && n.charCodeAt(2) === u) return `\\\\?\\${n}`;
          return e;
        },
        dirname(e) {
          d(e, 'path');
          ...
          } else g(i) && 58 === e.charCodeAt(1) && (r = n = t > 2 && h(e.charCodeAt(2)) ? 3 : 2);
          let o = -1,
            s = !0;
          for (let n = t - 1; n >= r; --n)
            if (h(e.charCodeAt(n))) {
        ...
        basename(e, t) {
          ...
          let n,
            ...
            o = !0;
          if (
            (e.length >= 2 && g(e.charCodeAt(0)) && 58 === e.charCodeAt(1) && (r = 2),
            ...
            for (n = e.length - 1; n >= r; --n) {
              ...
              if (h(l)) {
                ...
                -1 === a && ((o = !1), (a = n + 1)),
                  s >= 0 && (l === t.charCodeAt(s) ? -1 == --s && (i = n) : ((s = -1), (i = a)));
            }
        ...
        extname(e) {
          ...
          let t = 0,
            ...
            o = !0,
            s = 0;
          e.length >= 2 && 58 === e.charCodeAt(1) && g(e.charCodeAt(0)) && (t = r = 2);
        ...
        parse(e) {
          ...
          let r = 0,
            i = e.charCodeAt(0);
          if (1 === n) return h(i) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
          if (h(i)) {
          ...
          for (; c >= r; --c)
            if (h((i = e.charCodeAt(c)))) {
              ...
              -1 === l && ((u = !1), (l = c + 1)),
                i === a ? (-1 === o ? (o = c) : 1 !== f && (f = 1)) : -1 !== o && (f = -1);
          return (
            -1 !== l &&
              (-1 === o || 0 === f || (1 === f && o === l - 1 && o === s + 1)
                ? (t.base = t.name = e.slice(s, l))
                : ((t.name = e.slice(s, o)), (t.base = e.slice(s, l)), (t.ext = e.slice(o, l)))),
        ...
        (t.posix = {
          resolve(...e) {
            ...
            for (let i = e.length - 1; i >= -1 && !r; i--) {
              ...
              d(o, 'path'), 0 !== o.length && ((t = `${o}/${t}`), (r = o.charCodeAt(0) === l));
            }
          ...
          isAbsolute: (e) => (d(e, 'path'), e.length > 0 && e.charCodeAt(0) === l),
          join(...e) {
            if (0 === e.length) return '.';
            let n;
            for (let t = 0; t < e.length; ++t) {
              const r = e[t];
              d(r, 'path'), r.length > 0 && (void 0 === n ? (n = r) : (n += `/${r}`));
            }
          ...
          relative(e, n) {
            ...
            if (u === s)
              ...
              } else i > s && (e.charCodeAt(1 + u) === l ? (a = u) : 0 === u && (a = 0));
            let c = '';
            for (u = 1 + a + 1; u <= r; ++u) (u !== r && e.charCodeAt(u) !== l) || (c += 0 === c.length ? '..' : '/..');
    ...
    e(n[8], r([0, 1]), function (e, t) {
      ...
      function a(e, t, n = 0, r = e.length, i = 0, o = t.length) {
        for (; n < r && i < o; n++, i++) {
          ...
          if ((32 !== d || !u(c)) && (-32 !== d || !u(a)))
            return l(a) && l(c) ? d : s(e.toLowerCase(), t.toLowerCase(), n, r, i, o);
        }
        const a = r - n,
          c = o - i;
      ...
      function d(e, t, n = e.length) {
        for (let r = 0; r < n; r++) {
          ...
          if (n !== i)
            ...
            } else if (String.fromCharCode(n).toLowerCase() !== String.fromCharCode(i).toLowerCase()) return !1;
        }
        return !0;
      }
      function h(e) {
              ...
              ((o =
                i >= 240 && r + 3 < t
                  ? (((7 & e[r++]) << 18) >>> 0) |
                    ...
                    (((63 & e[r++]) << 0) >>> 0)
                  : i >= 224 && r + 2 < t
                  ? (((15 & e[r++]) << 12) >>> 0) | (((63 & e[r++]) << 6) >>> 0) | (((63 & e[r++]) << 0) >>> 0)
                  : i >= 192 && r + 1 < t
      ...
      const _ = /(?:[\u05BE\u05C0\u05C3\u05C6\u05D0-\u05F4\u0608\u060B\u060D\u061B-\u064A\u066D-\u066F\u0671-\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u0710\u0712-\u072F\u074D-\u07A5\u07B1-\u07EA\u07F4\u07F5\u07FA-\u0815\u081A\u0824\u0828\u0830-\u0858\u085E-\u08BD\u200F\uFB1D\uFB1F-\uFB28\uFB2A-\uFD3D\uFD50-\uFDFC\uFE70-\uFEFC]|\uD802[\uDC00-\uDD1B\uDD20-\uDE00\uDE10-\uDE33\uDE40-\uDEE4\uDEEB-\uDF35\uDF40-\uDFFF]|\uD803[\uDC00-\uDCFF]|\uD83A[\uDC00-\uDCCF\uDD00-\uDD43\uDD50-\uDFFF]|\uD83B[\uDC00-\uDEBB])/;
      ...
      (t.isBasicASCII = function (e) {
        ...
        (t.containsFullWidthCharacter = function (e) {
          for (let t = 0, n = e.length; t < n; t++) if (y(e.charCodeAt(t))) return !0;
          return !1;
        }),
    ...
    e(n[21], r([0, 1, 8]), function (e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.StringSHA1 = t.stringHash = t.doHash = t.hash = void 0),
        (t.hash = function (e) {
          return r(e, 0);
        }),
        (t.doHash = r),
      ...
      class u {
        ...
        update(e) {
          ...
          for (0 !== a ? ((i = a), (o = -1), (a = 0)) : ((i = e.charCodeAt(0)), (o = 0)); ; ) {
            let l = i;
            if (n.isHighSurrogate(i)) {
              ...
              }
              {
                ...
                n.isLowSurrogate(t) ? (o++, (l = n.computeCodePoint(i, t))) : (l = 65533);
              }
        ...
        _step() {
          ...
          for (let t = 64; t < 320; t += 4)
            e.setUint32(
              t,
              s(
                e.getUint32(t - 12, !1) ^ e.getUint32(t - 32, !1) ^ e.getUint32(t - 56, !1) ^ e.getUint32(t - 64, !1),
                1
              ),
              !1
            );
    ...
    e(n[9], r([0, 1, 14, 21]), function (e, t, n, r) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      class a {
        ...
        MarkNextChange() {
          (this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
            this.m_changes.push(
              new n.DiffChange(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount)
            ),
            (this.m_originalCount = 0),
            (this.m_modifiedCount = 0),
            (this.m_originalStart = 1073741824),
      ...
      class l {
        ...
        static _getElements(e) {
          ...
          if (l._isStringArray(t)) {
            ...
            for (let n = 0, i = t.length; n < i; n++) e[n] = r.stringHash(t[n], 0);
            return [t, e, !0];
          }
        ...
        ComputeDiffRecursive(e, t, r, i, s) {
          ...
          if (!s[0]) {
            ...
            return (
              (a = s[0]
                ? [new n.DiffChange(c + 1, t - (c + 1) + 1, d + 1, i - (d + 1) + 1)]
          ...
          do {
            ...
            t === S || (t < L && c[t - 1] < c[t + 1])
              ...
              : ((m = (h = c[t - 1] + 1) - A - i),
                ...
                (A = t - 1 - e)),
              w >= 0 && ((e = (c = this.m_forwardHistory[w])[0]), (S = 1), (L = c.length - 1));
          } while (--w >= -1);
            ...
            do {
              ...
              e === S || (e < L && d[e - 1] >= d[e + 1])
                ...
                : ((m = (h = d[e - 1]) - A - u),
                  ...
                  (A = e - 1 - o)),
                w >= 0 && ((o = (d = this.m_reverseHistory[w])[0]), (S = 1), (L = d.length - 1));
            } while (--w >= -1);
            v = E.getChanges();
          }
        ...
        ComputeRecursionPoint(e, t, r, i, o, a, l) {
          ...
          for (let L = 1; L <= m / 2 + 1; L++) {
            let m = 0,
              A = 0;
            (d = this.ClipDiagonalBound(b - L, L, b, p)), (h = this.ClipDiagonalBound(b + L, L, b, p));
            for (let e = d; e <= h; e += 2) {
              c = (u = e === d || (e < h && _[e - 1] < _[e + 1]) ? _[e + 1] : _[e - 1] + 1) - (e - b) - v;
              const n = u;
              for (; u < t && c < i && this.ElementsAreEqual(u + 1, c + 1); ) u++, c++;
              if (((_[e] = u), u + c > m + A && ((m = u), (A = c)), !S && Math.abs(e - y) <= L - 1 && u >= C[e]))
                return (
                  (o[0] = u),
                  (a[0] = c),
                  n <= C[e] && L <= 1448 ? this.WALKTRACE(b, d, h, v, y, f, g, E, _, C, u, t, o, c, i, a, S, l) : null
                );
            }
            const N = (m - e + (A - r) - L) / 2;
            if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(m, N))
              return (
                (l[0] = !0),
                (o[0] = m),
                (a[0] = A),
                N > 0 && L <= 1448
                  ? this.WALKTRACE(b, d, h, v, y, f, g, E, _, C, u, t, o, c, i, a, S, l)
                  : (e++, r++, [new n.DiffChange(e, t - e + 1, r, i - r + 1)])
              );
            (f = this.ClipDiagonalBound(y - L, L, y, p)), (g = this.ClipDiagonalBound(y + L, L, y, p));
            for (let n = f; n <= g; n += 2) {
              c = (u = n === f || (n < g && C[n - 1] >= C[n + 1]) ? C[n + 1] - 1 : C[n - 1]) - (n - y) - E;
              const s = u;
              ...
              if (((C[n] = u), S && Math.abs(n - b) <= L && u <= _[n]))
                return (
                  (o[0] = u),
                  (a[0] = c),
                  s >= _[n] && L <= 1448 ? this.WALKTRACE(b, d, h, v, y, f, g, E, _, C, u, t, o, c, i, a, S, l) : null
                );
            }
            if (L <= 1447) {
          ...
          return this.WALKTRACE(b, d, h, v, y, f, g, E, _, C, u, t, o, c, i, a, S, l);
        }
        PrettifyChanges(e) {
          for (let t = 0; t < e.length; t++) {
            const n = e[t],
          ...
          for (let t = e.length - 1; t >= 0; t--) {
            ...
            for (let e = 1; ; e++) {
              ...
              const c = this._boundaryScore(t, n.originalLength, u, n.modifiedLength);
              c > l && ((l = c), (a = e));
            }
    ...
    e(n[10], r([0, 1]), function (e, t) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.assertIsDefined = function (e) {
          if (i(e)) throw new Error('Assertion Failed: argument is undefined or null');
          return e;
        }),
        (t.isFunction = o),
    ...
    e(n[12], r([0, 1, 3, 20]), function (e, t, n, r) {
      'use strict';
      ...
      class c {
        ...
        with(e) {
          ...
          return (
            void 0 === t ? (t = this.scheme) : null === t && (t = a),
        ...
        static parse(e, t = !1) {
          const n = u.exec(e);
          return n ? new h(n[2] || a, b(n[4] || a), b(n[5] || a), b(n[7] || a), b(n[9] || a), t) : new h(a, a, a, a, a);
        }
        static file(e) {
          let t = a;
          if ((n.isWindows && (e = e.replace(/\\/g, l)), e[0] === l && e[1] === l)) {
            const n = e.indexOf(l, 2);
            -1 === n ? ((t = e.substring(2)), (e = l)) : ((t = e.substring(2, n)), (e = e.substring(n) || l));
          }
      ...
      class h extends c {
        ...
        toString(e = !1) {
          return e ? _(this, !0) : (this._formatted || (this._formatted = _(this, !1)), this._formatted);
        }
        toJSON() {
          const e = { $mid: 1 };
          return (
    ...
    e(n[33], r([0, 1, 4, 6, 3, 10]), function (e, t, n, r, i, o) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        _handleMessage(e) {
          if (e.seq) {
            ...
            if ((delete this._pendingReplies[t.seq], t.err)) {
              ...
              return (
                t.err.$isError &&
                  (((e = new Error()).name = t.err.name), (e.message = t.err.message), (e.stack = t.err.stack)),
                void n.reject(e)
              );
            }
          ...
          this._handler.handleMessage(t.method, t.args).then(
            (e) => {
              this._send({ vsWorker: this._workerId, seq: r, res: e, err: void 0 });
            },
            (e) => {
              e.detail instanceof Error && (e.detail = n.transformErrorForSerialization(e.detail)),
                this._send({ vsWorker: this._workerId, seq: r, res: void 0, err: n.transformErrorForSerialization(e) });
            }
          );
        }
        _send(e) {
      ...
      class u extends r.Disposable {
        constructor(e, t, n) {
          ...
          void 0 !== self.require && 'function' == typeof self.require.getConfig
            ...
            : void 0 !== self.requirejs && (i = self.requirejs.s.contexts._.config);
          const a = o.getAllMethodNames(n);
          this._onModuleLoaded = this._protocol.sendMessage(s, [
            this._worker.getId(),
      ...
      class c {
        ...
        initialize(e, t, n, r) {
          ...
          const i = o.createProxyObject(r, (e, t) => this._protocol.sendMessage(e, t));
    ...
    e(n[22], r([0, 1, 11]), function (e, t, n) {
      'use strict';
    ...
    e(n[23], r([0, 1, 2, 5]), function (e, t, n, r) {
      'use strict';
      ...
      class i extends r.Range {
        ...
        static liftSelection(e) {
          return new i(e.selectionStartLineNumber, e.selectionStartColumn, e.positionLineNumber, e.positionColumn);
        }
    ...
    e(n[25], r([0, 1, 9, 8]), function (e, t, n, r) {
      'use strict';
      ...
      class s {
        constructor(e) {
          const t = [],
            n = [];
          for (let r = 0, i = e.length; r < i; r++) (t[r] = c(e[r], 1)), (n[r] = d(e[r], 1));
        ...
        createCharSequence(e, t, n) {
          ...
          for (let a = t; a <= n; a++) {
            ...
            for (let e = n; e < l; e++) (r[s] = t.charCodeAt(e - 1)), (i[s] = a + 1), (o[s] = e), s++;
          }
          return new a(r, i, o);
        }
      }
          ...
          if (
            (0 === t.originalLength
              ...
              : ((d = n.getStartLineNumber(t.originalStart)),
                (h = n.getEndLineNumber(t.originalStart + t.originalLength - 1))),
            0 === t.modifiedLength
              ? ((f = r.getStartLineNumber(t.modifiedStart) - 1), (g = 0))
              : ((f = r.getStartLineNumber(t.modifiedStart)),
                (g = r.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1))),
            a && t.originalLength > 0 && t.originalLength < 20 && t.modifiedLength > 0 && t.modifiedLength < 20 && s())
          ) {
            const a = n.createCharSequence(e, t.originalStart, t.originalStart + t.originalLength - 1),
              u = r.createCharSequence(e, t.modifiedStart, t.modifiedStart + t.modifiedLength - 1);
            ...
            c &&
              ...
              (m = []);
            for (let e = 0, t = d.length; e < t; e++) m.push(l.createFromDiffChange(d[e], a, u));
          }
      ...
      t.DiffComputer = class {
        ...
        computeDiff() {
          ...
          const e = o(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
            t = e.changes,
            n = e.quitEarly;
        ...
        _pushTrimWhitespaceCharChange(e, t, n, r, i, o, s) {
          ...
          let a = void 0;
          this.shouldComputeCharChanges && (a = [new l(t, n, t, r, i, o, i, s)]), e.push(new u(t, t, i, i, a));
        }
        _mergeTrimWhitespaceCharChange(e, t, n, r, i, o, s) {
          ...
          return (
            ...
            this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new l(t, n, t, r, i, o, i, s)),
            !0)
          );
        }
      };
    ...
    e(n[26], r([0, 1]), function (e, t) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.DEFAULT_WORD_REGEXP = (function (e = '') {
          let n = '(-?\\d*\\.\\d\\w*)|([^';
          for (const r of t.USUAL_WORD_SEPARATORS) e.indexOf(r) >= 0 || (n += '\\' + r);
      ...
      t.getWordAtText = function e(t, i, o, s, a = n) {
        if (o.length > a.maxLen) {
          let n = t - a.maxLen / 2;
          return n < 0 ? ((s += t), (n = 0)) : (s += n), e(t, i, (o = o.substring(n, t + a.maxLen / 2)), s, a);
        }
        Date.now();
        const l = t - 1 - s;
        let u = -1,
        ...
        if (c) {
          let e = { word: c[0], startColumn: s + 1 + c.index, endColumn: s + 1 + c.index + c[0].length };
          return (i.lastIndex = 0), e;
        }
        return null;
      };
    }),
    e(n[27], r([0, 1, 22]), function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
          ...
          for (let n = 1, i = e.getLineCount(); n <= i; n++) {
            ...
            for (; s < o; ) {
              ...
              if (13 === d) {
                ...
                let t;
                91 === o ? ((f = !0), (t = 0)) : (t = r.get(o)), 1 === t ? (e = !0) : (d = 13);
    ...
    e(n[30], r([0, 1, 18, 7, 16, 12, 2, 5, 23, 24, 29]), function (e, t, n, r, i, o, s, a, l, u, c) {
      'use strict';
    ...
    e(n[31], r([0, 1, 11]), function (e, t, n) {
      'use strict';
    ...
    e(n[32], r([0, 1, 2, 31]), function (e, t, n, r) {
      'use strict';
      ...
      t.MirrorTextModel = class {
        ...
        onEvents(e) {
          ...
          for (const e of t)
            this._acceptDeleteRange(e.range),
              this._acceptInsertText(new n.Position(e.range.startLineNumber, e.range.startColumn), e.text);
        ...
        _acceptInsertText(e, t) {
          ...
          for (let t = 1; t < n.length; t++)
            this._lines.splice(e.lineNumber + t - 1, 0, n[t]), (r[t - 1] = n[t].length + this._eol.length);
  ...
  e(n[34], r([0, 1, 13, 9, 3, 12, 2, 5, 25, 32, 26, 27, 28, 30, 10]), function (
    e,
    t,
    n,
    r,
    ...
    class p extends c.MirrorTextModel {
      get uri() {
        return this._uri;
      }
      get version() {
      ...
      getWordAtPosition(e, t) {
        let n = d.getWordAtText(e.column, d.ensureValidWordDefinition(t), this._lines[e.lineNumber - 1], 0);
      ...
      getLineWords(e, t) {
        let n = this._lines[e - 1],
          ...
          i = [];
        for (const e of r)
          i.push({ word: n.substring(e.start, e.end), startColumn: e.start + 1, endColumn: e.end + 1 });
        return i;
      }
      _wordenize(e, t) {
        const n = [];
    ...
    class _ {
      ...
      acceptNewModel(e) {
        this._models[e.url] = new p(o.URI.parse(e.url), e.lines, e.EOL, e.versionId);
      }
      ...
      computeMoreMinimalEdits(e, t) {
        return s(this, void 0, void 0, function* () {
          ...
          for (let { range: e, text: n, eol: a } of t) {
            if (('number' == typeof a && (s = a), l.Range.isEmpty(e) && !n)) continue;
            const t = i.getValueInRange(e);
            if (t === (n = n.replace(/\r\n|\n|\r/g, i.eol))) continue;
            if (Math.max(n.length, t.length) > _._diffLimit) {
      ...
      textualSuggest(e, t, n, r) {
        return s(this, void 0, void 0, function* () {
          ...
          const o = [],
            s = new Set(),
            a = new RegExp(n, r),
            l = i.getWordAtPosition(t, a);
          l && s.add(i.getValueInRange(l));
          for (let e of i.words(a))
            if (!s.has(e) && (s.add(e), isNaN(Number(e)) && (o.push(e), s.size > _._suggestionsLimit))) break;
          return o;
        });
      }
      ...
      navigateValueSet(e, t, n, r, i) {
        return s(this, void 0, void 0, function* () {
          ...
          return f.BasicInplaceReplace.INSTANCE.navigateValueSet(t, a, l, u, n);
        });
      }
        ...
        return this._foreignModuleFactory
          ...
          : new Promise((r, o) => {
              e(
                [t],
                (e) => {
                  (this._foreignModule = e.create(i, n)), r(m.getAllMethodNames(this._foreignModule));
                },
                o
              );
            });
    ...
    (t.EditorSimpleWorker = _),
      ...
      'function' == typeof importScripts && (i.globals.monaco = g.createMonacoBaseAPI());
  }),
    (function () {
      let e = self.MonacoEnvironment,
            ...
            (function (e) {
              require([e], function (e) {
                setTimeout(function () {
                  ...
                  for (self.onmessage = (e) => t.onmessage(e.data); r.length > 0; ) self.onmessage(r.shift());
                }, 0);
              });
            })(e.data))
          : r.push(e);
