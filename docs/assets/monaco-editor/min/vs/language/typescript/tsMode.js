        ...
        (e.prototype.getOrCreateModel = function (e) {
          ...
          return (
            ...
            (this.isLibFile(e) && this._hasFetchedLibFiles
              ? r.editor.createModel(this._libFiles[e.path.slice(1)], 'javascript', e)
              : null)
          );
        }),
  ...
  var c = (function (e) {
    function t(t, n, i, o) {
      ...
      s._disposables.push(r.editor.onDidCreateModel(a)),
        ...
        s._disposables.push(
          r.editor.onDidChangeModelLanguage(function (e) {
            l(e.model), a(e.model);
          })
        ),
        s._disposables.push({
      ...
      return (
        s._disposables.push(s._defaults.onDidChange(u)),
    ...
    return (
              ...
              case 2:
                return !(l = p.sent()) || e.isDisposed()
                  ...
                  : ((u = l
                      ...
                      .filter(function (e) {
                        return (
                          -1 === (d._defaults.getDiagnosticsOptions().diagnosticCodesToIgnore || []).indexOf(e.code)
                        );
                      })),
                    (c = u
                      .map(function (e) {
      ...
      (t.prototype._convertDiagnostics = function (e, t) {
        var n = t.start || 0,
          ...
          p = [];
        return (
          t.reportsUnnecessary && p.push(r.MarkerTag.Unnecessary),
        ...
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (u) {
            switch (u.label) {
              case 0:
                return (
                  (i = e.getWordUntilPosition(n)),
                  (o = new r.Range(n.lineNumber, i.startColumn, n.lineNumber, i.endColumn)),
                  (s = e.uri),
                  (a = e.getOffsetAt(n)),
                  [4, this._worker(s)]
                );
              case 1:
                return [4, u.sent().getCompletionsAtPosition(s.toString(), a)];
              case 2:
                return !(l = u.sent()) || e.isDisposed()
                  ? [2]
                  : [
                      2,
                      {
                        suggestions: l.entries.map(function (i) {
                          var l,
                            u = o;
                          if (i.replacementSpan) {
                            var c = e.getPositionAt(i.replacementSpan.start),
                              d = e.getPositionAt(i.replacementSpan.start + i.replacementSpan.length);
                            u = new r.Range(c.lineNumber, c.column, d.lineNumber, d.column);
                          }
                          var p = [];
                          return (
                            -1 !==
                              (null === (l = i.kindModifiers) || void 0 === l ? void 0 : l.indexOf('deprecated')) &&
      ...
      (t.prototype.resolveCompletionItem = function (e, n) {
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (l) {
            switch (l.label) {
              case 0:
                return (r = (n = e).uri), (i = n.position), (o = n.offset), [4, this._worker(r)];
              case 1:
                return [4, l.sent().getCompletionEntryDetails(r.toString(), o, n.label)];
              case 2:
                return (a = l.sent())
                  ? [
                      2,
        ...
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (a) {
            switch (a.label) {
              ...
              case 1:
                return [4, a.sent().getSignatureHelpItems(n.toString(), r)];
              case 2:
                return !(i = a.sent()) || e.isDisposed()
                  ? [2]
                  : ((o = { activeSignature: i.selectedItemIndex, activeParameter: i.argumentIndex, signatures: [] }),
                      ...
                      (t.documentation = { value: s(e.documentation) }),
                        ...
                        e.parameters.forEach(function (n, r, i) {
                          var o = s(n.displayParts),
                            a = { label: o, documentation: { value: s(n.documentation) } };
                          (t.label += o),
                            t.parameters.push(a),
                            r < i.length - 1 && (t.label += s(e.separatorDisplayParts));
                        }),
          ...
          return __generator(this, function (u) {
            switch (u.label) {
              case 0:
                return (n = e.uri), (r = e.getOffsetAt(t)), [4, this._worker(n)];
              case 1:
                return [4, u.sent().getQuickInfoAtPosition(n.toString(), r)];
              case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (a) {
            switch (a.label) {
              ...
              case 1:
                return [4, a.sent().getOccurrencesAtPosition(n.toString(), i)];
              case 2:
          ...
          return __generator(this, function (p) {
            switch (p.label) {
              case 0:
                return (n = e.uri), (i = e.getOffsetAt(t)), [4, this._worker(n)];
              case 1:
                return [4, p.sent().getDefinitionAtPosition(n.toString(), i)];
              case 2:
                ...
                for (s = [], a = 0, l = o; a < l.length; a++)
                  (u = l[a]),
                    ...
                    (d = this._libFiles.getOrCreateModel(c)) &&
                      s.push({ uri: c, range: this._textSpanToRange(d, u.textSpan) });
                return [2, s];
            }
          });
        });
          ...
          return __generator(this, function (p) {
            switch (p.label) {
              case 0:
                return (n = e.uri), (i = e.getOffsetAt(t)), [4, this._worker(n)];
              case 1:
                return [4, p.sent().getReferencesAtPosition(n.toString(), i)];
              case 2:
                return !(o = p.sent()) || e.isDisposed()
                  ? [2]
                  : [
        ...
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (l) {
            switch (l.label) {
              ...
              case 1:
                return [4, l.sent().getFormattingEditsForRange(r.toString(), i, o, y._convertOptions(n))];
              case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (l) {
            switch (l.label) {
              ...
              case 1:
                return [4, l.sent().getFormattingEditsAfterKeystroke(i.toString(), o, n, y._convertOptions(r))];
              case 2:
                return !(s = l.sent()) || e.isDisposed()
                  ? [2]
                  : [
        ...
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (c) {
            switch (c.label) {
              ...
              case 1:
                return [4, c.sent().getCodeFixesAtPosition(r.toString(), i, o, a, s)];
              case 2:
                  ...
                  : [
                      2,
                      {
                        actions: l
                          ...
                          .map(function (t) {
                            return u._tsCodeFixActionToMonacoCodeAction(e, n, t);
                          }),
                        dispose: function () {},
                      },
                    ];
      ...
      (t.prototype.provideRenameEdits = function (e, t, n, i) {
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (g) {
            switch (g.label) {
              case 0:
                return (i = e.uri), (o = i.toString()), (s = e.getOffsetAt(t)), [4, this._worker(i)];
              case 1:
                return [4, (a = g.sent()).getRenameInfo(o, s, { allowRenameOfImportPath: !1 })];
              case 2:
                if (!1 === (l = g.sent()).canRename) return [2, { edits: [], rejectReason: l.localizedErrorMessage }];
                if (void 0 !== l.fileToRename) throw new Error('Renaming files is not supported.');
                ...
                for (c = [], d = 0, p = u; d < p.length; d++)
                  (f = p[d]),
                    c.push({
                      ...
                      edit: { range: this._textSpanToRange(e, f.textSpan), text: n },
                    });
                return [2, { edits: c }];
            }
          });
  ...
  define('vs/language/typescript/tsMode', [
    ...
    function a(e, t) {
      var o = new n.WorkerManager(t, e),
        ...
        a = new r.LibFiles(s);
      return (
        i.languages.registerCompletionItemProvider(t, new r.SuggestAdapter(s)),
        i.languages.registerSignatureHelpProvider(t, new r.SignatureHelpAdapter(s)),
        i.languages.registerHoverProvider(t, new r.QuickInfoAdapter(s)),
        i.languages.registerDocumentHighlightProvider(t, new r.OccurrencesAdapter(s)),
        i.languages.registerDefinitionProvider(t, new r.DefinitionAdapter(a, s)),
        i.languages.registerReferenceProvider(t, new r.ReferenceAdapter(a, s)),
        i.languages.registerDocumentSymbolProvider(t, new r.OutlineAdapter(s)),
        i.languages.registerDocumentRangeFormattingEditProvider(t, new r.FormatAdapter(s)),
        i.languages.registerOnTypeFormattingEditProvider(t, new r.FormatOnTypeAdapter(s)),
