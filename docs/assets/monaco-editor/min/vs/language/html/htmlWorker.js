        ...
        switch (T) {
          ...
          case i.ScannerState.WithinTag:
            return y.skipWhitespace()
              ...
              : g && (_ = y.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase()).length > 0
      ...
      return (
        ...
        (e.prototype._doComplete = function (e, t, o, c) {
          var h = { isIncomplete: !1, items: [] },
            ...
            _ = e.getText(),
            v = e.offsetAt(t),
            w = o.findNodeBefore(v);
          if (!w) return h;
          var y,
            T = i.createScanner(_, w.start),
            k = '';
          function S(t, n) {
            return void 0 === n && (n = v), t > v && (t = v), { start: e.positionAt(t), end: e.positionAt(n) };
          }
          function x(e, t) {
            var i = S(e, t);
            return (
          ...
          function L(e) {
            for (var t = e; t > 0; ) {
              var n = _.charAt(t - 1);
              if ('\n\r'.indexOf(n) >= 0) return _.substring(t, e);
              if (!m(n)) return null;
              t--;
            }
            return _.substring(0, e);
          }
          function M(e, t, i) {
            void 0 === i && (i = v);
            var a = S(e, i),
              o = f(_, i, r.ScannerState.WithinEndTag, r.TokenType.EndTagClose) ? '' : '>',
              s = w;
            for (t && (s = s.parent); s; ) {
              var l = s.tag;
              if (l && (!s.closed || (s.endTagStart && s.endTagStart > v))) {
                var c = {
                    label: '/' + l,
                    kind: n.CompletionItemKind.Property,
                    filterText: '/' + l,
          ...
          function R(e, t) {
            void 0 === t && (t = v);
            for (var i = v; i < t && '<' !== _[i]; ) i++;
            var a = S(e, i),
              l = f(_, t, r.ScannerState.AfterAttributeName, r.TokenType.DelimiterAssign) ? '' : '="$1"',
          ...
          function z(i, r) {
            var a, o, s, l;
            if ((void 0 === r && (r = v), v > i && v <= r && ((l = _[i]), /^["']*$/.test(l)))) {
              var c = i + 1,
                u = r;
              r > i && _[r - 1] === _[i] && u--;
              ...
              (a = S(f, w)), (s = v >= c && v <= u ? _.substring(c, v) : ''), (o = !1);
            } else (a = S(i, r)), (s = _.substring(i, v)), (o = !0);
            if (p.length > 0)
          ...
          function H(e) {
            return v === T.getTokenEnd() && (W = T.scan()) === e && T.getTokenOffset() === v ? T.getTokenEnd() : v;
          }
          function C() {
          ...
          function I() {
            for (var e = v - 1, i = t.character; e >= 0 && s.isLetterOrDigit(_, e); ) e--, i--;
            if (e >= 0 && '&' === _[e]) {
          ...
          for (var U, W = T.scan(); W !== r.TokenType.EOS && T.getTokenOffset() <= v; ) {
            switch (W) {
              case r.TokenType.StartTagOpen:
                if (T.getTokenEnd() === v) {
                  var D = H(r.TokenType.StartTag);
                  return (
                    0 === t.line &&
                      ((U = void 0),
                      (U = S(v, D)),
                ...
                break;
              case r.TokenType.StartTag:
                if (T.getTokenOffset() <= v && v <= T.getTokenEnd()) return x(T.getTokenOffset(), T.getTokenEnd());
                k = T.getTokenText();
                break;
              case r.TokenType.AttributeName:
                if (T.getTokenOffset() <= v && v <= T.getTokenEnd()) return R(T.getTokenOffset(), T.getTokenEnd());
                y = T.getTokenText();
                break;
              case r.TokenType.DelimiterAssign:
                if (T.getTokenEnd() === v) {
                  D = H(r.TokenType.AttributeValue);
                  return z(v, D);
                }
                break;
              case r.TokenType.AttributeValue:
                if (T.getTokenOffset() <= v && v <= T.getTokenEnd()) return z(T.getTokenOffset(), T.getTokenEnd());
                break;
              case r.TokenType.Whitespace:
                if (v <= T.getTokenEnd())
                  switch (T.getScannerState()) {
                    case r.ScannerState.AfterOpeningStartTag:
                      return A(T.getTokenOffset(), H(r.TokenType.StartTag));
                ...
                break;
              case r.TokenType.EndTagOpen:
                if (v <= T.getTokenEnd()) return M(T.getTokenOffset() + 1, !1, H(r.TokenType.EndTag));
                break;
              case r.TokenType.EndTag:
                if (v <= T.getTokenEnd())
                  for (var O = T.getTokenOffset() - 1; O >= 0; ) {
                    var P = _.charAt(O);
                    if ('/' === P) return M(O, !1, T.getTokenEnd());
                    if (!m(P)) break;
                    O--;
                  }
                break;
              case r.TokenType.StartTagClose:
                if (v <= T.getTokenEnd() && k) return E(T.getTokenEnd(), k);
                break;
              case r.TokenType.Content:
                if (v <= T.getTokenEnd()) return C();
                break;
              default:
                if (v <= T.getTokenEnd()) return h;
            }
            W = T.scan();
          }
          return h;
...
define('vs/language/html/htmlWorker', ['require', 'exports', 'vscode-html-languageservice'], function (e, t, n) {
  'use strict';
