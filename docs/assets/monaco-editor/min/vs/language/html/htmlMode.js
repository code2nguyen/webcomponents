...
define('vs/language/html/workerManager', ['require', 'exports', './fillers/monaco-editor-core'], function (e, t, n) {
  ...
  (function (e) {
          ...
          (e.prototype.getTextEditChange = function (e) {
            if (f.is(e)) {
              ...
              if (!(i = this._textEditChanges[t.uri])) {
                ...
                this._workspaceEdit.documentChanges.push(n), (i = new _(r)), (this._textEditChanges[t.uri] = i);
              }
              return i;
            }
            if (
            ...
            if (!(i = this._textEditChanges[e])) {
              var r = [];
              (this._workspaceEdit.changes[e] = r), (i = new _(r)), (this._textEditChanges[e] = i);
            }
            return i;
          }),
    ...
    (t.WorkspaceChange = w),
      ...
      })((v = t.MarkedString || (t.MarkedString = {}))),
      (function (e) {
        e.is = function (e) {
          var t = e;
          return (
            !!t &&
            y.objectLiteral(t) &&
            (b.is(t.contents) || v.is(t.contents) || y.typedArray(t.contents, v.is)) &&
...
!(function (e) {
  ...
  'use strict';
  Object.defineProperty(t, '__esModule', { value: !0 }),
    (t.FileType = t.ClientCapabilities = t.ScannerState = t.TokenType = t.TextDocument = void 0);
  ...
  (function (e) {
    ...
    var n = e('vscode-nls'),
      ...
      b = ' '.charCodeAt(0),
      v = '\t'.charCodeAt(0),
      _ = { 'text/x-handlebars-template': !0 };
      ...
      function M() {
        ...
        switch (T) {
          ...
          case i.ScannerState.AfterOpeningEndTag:
            return x().length > 0
              ...
              : ((T = i.ScannerState.WithinEndTag),
                ...
                t < y.pos() ? L(t, i.TokenType.Unknown, r('error.endTagNameExpected', 'End tag name expected.')) : M());
          case i.ScannerState.WithinEndTag:
            ...
            if (m && y.peekChar() === l)
              return (
                ...
                L(t, i.TokenType.EndTagClose, r('error.closingBracketMissing', 'Closing bracket missing.'))
              );
            ...
            return (
              ...
              b.length > 0
                ...
                : ((T = i.ScannerState.WithinTag),
                  y.advanceUntilChar(c),
                  t < y.pos()
                    ? L(t, i.TokenType.Unknown, r('error.startTagNameExpected', 'Start tag name expected.'))
                    : M())
            );
          case i.ScannerState.WithinTag:
            return y.skipWhitespace()
              ? ((g = !0), L(t, i.TokenType.Whitespace))
              : g && (v = y.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase()).length > 0
              ...
              : m && y.peekChar() === l
              ? ((T = i.ScannerState.WithinContent),
                L(t, i.TokenType.StartTagClose, r('error.closingBracketMissing', 'Closing bracket missing.')))
              : (y.advance(1),
                L(t, i.TokenType.Unknown, r('error.unexpectedCharacterInTag', 'Unexpected character in tag.')));
          ...
          case i.ScannerState.BeforeAttributeValue:
            ...
            if (n.length > 0)
              return (
                y.peekChar() === c && y.peekChar(-1) === d && (y.goBack(1), (n = n.substr(0, n.length - 1))),
                'type' === v && (w = n),
                (T = i.ScannerState.WithinTag),
                (g = !1),
      ...
      return {
        scan: function () {
          ...
          return n === i.TokenType.EOS ||
            ...
            ? n
            : (console.log('Scanner.scan has not advanced at offset ' + e + ', state before: ' + t + ' after: ' + T),
              y.advance(1),
  ...
  (function (e) {
    ...
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.isVoidElement = t.VOID_ELEMENTS = void 0);
  ...
  (function (e) {
    ...
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.generateDocumentation = t.HTMLDataProvider = void 0);
        ...
        (e.prototype.computeCompletions = function (e, t) {
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (f) {
              switch (f.label) {
                case 0:
                  (r = { items: [], isIncomplete: !1 }), (a = 0), (o = this.atributeCompletions), (f.label = 1);
                case 1:
                  return a < o.length
                    ? ((l = o[a]),
                      (function (e) {
        ...
        (e.prototype.providePathSuggestions = function (e, t, i, r) {
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (g) {
              switch (g.label) {
                case 0:
                  if (((s = e.substring(0, e.lastIndexOf('/') + 1)), !(l = r.resolveReference(s || '.', i.uri))))
                    return [3, 4];
                  g.label = 1;
                case 1:
...
!(function (e) {
  ...
  var n = e('vscode-languageserver-types'),
    ...
    o = e('vscode-nls'),
    s = e('../utils/strings'),
    l = e('../languageFacts/fact'),
    c = e('../utils/object'),
    d = e('../languageFacts/dataProvider'),
    h = e('./pathCompletion'),
    ...
    p = (function () {
      ...
      return (
            ...
            return __generator(this, function (c) {
              switch (c.label) {
                case 0:
                  ...
                  (a = new h.PathCompletionParticipant(this.lsOptions.fileSystemProvider.readDirectory)),
        ...
        (e.prototype._doComplete = function (e, t, o, c) {
          var h = { isIncomplete: !1, items: [] },
            p = this.completionParticipants,
            g = this.dataManager.getDataProviders().filter(function (t) {
              return t.isApplicable(e.languageId) && (!c || !1 !== c[t.getId()]);
            }),
            b = this.doesSupportMarkdown(),
            v = e.getText(),
            _ = e.offsetAt(t),
            w = o.findNodeBefore(_);
          if (!w) return h;
          var y,
            T = i.createScanner(v, w.start),
            k = '';
          function S(t, n) {
            return void 0 === n && (n = _), t > _ && (t = _), { start: e.positionAt(t), end: e.positionAt(n) };
          }
          function x(e, t) {
            var i = S(e, t);
            return (
              g.forEach(function (e) {
                e.provideTags().forEach(function (e) {
                  h.items.push({
                    ...
                    documentation: d.generateDocumentation(e, b),
          ...
          function M(e, t, i) {
            ...
            for (t && (s = s.parent); s; ) {
              var l = s.tag;
              if (l && (!s.closed || (s.endTagStart && s.endTagStart > _))) {
                var c = {
                    label: '/' + l,
                    kind: n.CompletionItemKind.Property,
                    filterText: '/' + l,
                  ...
                  u = L(s.start),
                  p = L(e - 1);
                if (null !== u && null !== p && u !== p) {
                  var m = u + '</' + l + o;
                  (c.textEdit = n.TextEdit.replace(S(e - 1 - p.length), m)), (c.filterText = p + '</' + l);
                }
                return h.items.push(c), h;
              }
              s = s.parent;
            }
            return (
          ...
          function E(t, i) {
            if (c && c.hideAutoCompleteProposals) return h;
            if (!l.isVoidElement(i)) {
          ...
          function A(e, t) {
            return x(e, t), M(e, !0, t), h;
          }
          function R(e, t) {
            void 0 === t && (t = _);
            for (var i = _; i < t && '<' !== v[i]; ) i++;
            var a = S(e, i),
              l = f(v, t, r.ScannerState.AfterAttributeName, r.TokenType.DelimiterAssign) ? '' : '="$1"',
              c = Object.create(null);
            return (
              g.forEach(function (e) {
                e.provideAttributes(k).forEach(function (e) {
                  if (!c[e.name]) {
                    c[e.name] = !0;
                    var t,
                      i = e.name;
          ...
          function C(i, r) {
            var a, o, s, l;
            if ((void 0 === r && (r = _), _ > i && _ <= r && ((l = v[i]), /^["']*$/.test(l)))) {
              var c = i + 1,
                u = r;
              r > i && v[r - 1] === v[i] && u--;
              ...
              (a = S(f, w)), (s = _ >= c && _ <= u ? v.substring(c, _) : ''), (o = !1);
            } else (a = S(i, r)), (s = v.substring(i, _)), (o = !0);
            if (p.length > 0)
              for (var T = k.toLowerCase(), x = y.toLowerCase(), L = S(i, r), M = 0, E = p; M < E.length; M++) {
                var A = E[M];
                A.onHtmlAttributeValue &&
                  A.onHtmlAttributeValue({ document: e, position: t, tag: T, attribute: x, value: s, range: L });
              }
            return (
              g.forEach(function (e) {
                e.provideValues(k, y).forEach(function (e) {
          ...
          function I(e) {
            return _ === T.getTokenEnd() && (W = T.scan()) === e && T.getTokenOffset() === _ ? T.getTokenEnd() : _;
          }
          function H() {
          ...
          function z() {
            for (var e = _ - 1, i = t.character; e >= 0 && s.isLetterOrDigit(v, e); ) e--, i--;
            if (e >= 0 && '&' === v[e]) {
          ...
          for (var U, W = T.scan(); W !== r.TokenType.EOS && T.getTokenOffset() <= _; ) {
            switch (W) {
              case r.TokenType.StartTagOpen:
                if (T.getTokenEnd() === _) {
                  var D = I(r.TokenType.StartTag);
                  return (
                    0 === t.line &&
                      ((U = void 0),
                      (U = S(_, D)),
                      h.items.push({
                        ...
                        textEdit: n.TextEdit.replace(U, '!DOCTYPE html>'),
                        insertTextFormat: n.InsertTextFormat.PlainText,
                      })),
                    A(_, D)
                  );
                ...
                break;
              case r.TokenType.StartTag:
                if (T.getTokenOffset() <= _ && _ <= T.getTokenEnd()) return x(T.getTokenOffset(), T.getTokenEnd());
                k = T.getTokenText();
                break;
              case r.TokenType.AttributeName:
                if (T.getTokenOffset() <= _ && _ <= T.getTokenEnd()) return R(T.getTokenOffset(), T.getTokenEnd());
                y = T.getTokenText();
                break;
              case r.TokenType.DelimiterAssign:
                if (T.getTokenEnd() === _) {
                  D = I(r.TokenType.AttributeValue);
                  return C(_, D);
                }
                break;
              case r.TokenType.AttributeValue:
                if (T.getTokenOffset() <= _ && _ <= T.getTokenEnd()) return C(T.getTokenOffset(), T.getTokenEnd());
                break;
              case r.TokenType.Whitespace:
                if (_ <= T.getTokenEnd())
                  switch (T.getScannerState()) {
                    case r.ScannerState.AfterOpeningStartTag:
                      return A(T.getTokenOffset(), I(r.TokenType.StartTag));
                    case r.ScannerState.WithinTag:
                    case r.ScannerState.AfterAttributeName:
                      return R(T.getTokenEnd());
                    case r.ScannerState.BeforeAttributeValue:
                      return C(T.getTokenEnd());
                    case r.ScannerState.AfterOpeningEndTag:
                      return M(T.getTokenOffset() - 1, !1);
                    case r.ScannerState.WithinContent:
                      return H();
                  }
                break;
              case r.TokenType.EndTagOpen:
                if (_ <= T.getTokenEnd()) return M(T.getTokenOffset() + 1, !1, I(r.TokenType.EndTag));
                break;
              case r.TokenType.EndTag:
                if (_ <= T.getTokenEnd())
                  for (var P = T.getTokenOffset() - 1; P >= 0; ) {
                    var O = v.charAt(P);
                    if ('/' === O) return M(P, !1, T.getTokenEnd());
                    if (!m(O)) break;
                    P--;
                  }
                break;
              case r.TokenType.StartTagClose:
                if (_ <= T.getTokenEnd() && k) return E(T.getTokenEnd(), k);
                break;
              case r.TokenType.Content:
                if (_ <= T.getTokenEnd()) return H();
                break;
              default:
                if (_ <= T.getTokenEnd()) return h;
            }
        ...
        (e.prototype.doTagComplete = function (e, t, n) {
          ...
          if ('>' === o) {
            if (
              (c = n.findNodeBefore(a)) &&
              c.tag &&
              !l.isVoidElement(c.tag) &&
              c.start < a &&
              (!c.endTagStart || c.endTagStart > a)
            )
              for (
                var s = (d = i.createScanner(e.getText(), c.start)).scan();
                s !== r.TokenType.EOS && d.getTokenEnd() <= a;

              ) {
                if (s === r.TokenType.StartTagClose && d.getTokenEnd() === a) return '$0</' + c.tag + '>';
                s = d.scan();
              }
          } else if ('/' === o) {
            for (var c = n.findNodeBefore(a); c && c.closed; ) c = c.parent;
            if (c && c.tag) {
              var d;
              for (
                s = (d = i.createScanner(e.getText(), c.start)).scan();
                s !== r.TokenType.EOS && d.getTokenEnd() <= a;

              ) {
                if (s === r.TokenType.EndTagOpen && d.getTokenEnd() === a) return c.tag + '>';
                s = d.scan();
              }
            }
          }
        ...
        (e.prototype.doesSupportMarkdown = function () {
          ...
          if (!c.isDefined(this.supportsMarkdown)) {
            if (!c.isDefined(this.lsOptions.clientCapabilities))
              ...
              null ===
                (i =
                  null ===
                    ...
                    ? void 0
                    : t.completionItem) || void 0 === i
                ? void 0
                : i.documentationFormat;
            this.supportsMarkdown = Array.isArray(r) && -1 !== r.indexOf(n.MarkupKind.Markdown);
          }
  ...
  (function (e) {
    ...
    var n = e('../parser/htmlScanner'),
      ...
      r = e('../htmlLanguageTypes'),
      a = e('../utils/object'),
      o = e('../languageFacts/dataProvider'),
      s = (function () {
        function e(e, t) {
        ...
        return (
          (e.prototype.doHover = function (e, t, i) {
                    ...
                    if (
                      (n.provideTags().forEach(function (n) {
                        if (n.name.toLowerCase() === e.toLowerCase()) {
                          var r = o.generateDocumentation(n, s);
                          r || (r = { kind: s ? 'markdown' : 'plaintext', value: '' }), (i = { contents: r, range: t });
                        }
                      }),
                      i)
                    )
            ...
            function u(t, i) {
              for (
                ...
                o !== r.TokenType.EOS && (a.getTokenEnd() < l || (a.getTokenEnd() === l && o !== t));

              )
                o = a.scan();
              return o === t && l <= a.getTokenEnd()
                ? { start: e.positionAt(a.getTokenOffset()), end: e.positionAt(a.getTokenEnd()) }
                : null;
            }
            if (c.endTagStart && l >= c.endTagStart) {
              var p = u(r.TokenType.EndTag, c.endTagStart);
              return p ? h(c.tag, p) : null;
            }
            var m = u(r.TokenType.StartTag, c.start);
            if (m) return h(c.tag, m);
            var f = u(r.TokenType.AttributeName, c.start);
            if (f)
              return (function (e, t, n) {
                      ...
                      if (
                        (i.provideAttributes(e).forEach(function (e) {
                          if (t === e.name && e.description) {
                            var i = o.generateDocumentation(e, s);
                ...
                return null;
              })((b = c.tag), e.getText(f), f);
            var g = u(r.TokenType.AttributeValue, c.start);
            if (g) {
              var b = c.tag,
                v = (function (e) {
                        ...
                        if (
                          (r.provideValues(e, t).forEach(function (e) {
                            if (n === e.name && e.description) {
                              var t = o.generateDocumentation(e, s);
                              l = t ? { contents: t, range: i } : null;
                            }
                          }),
                          l)
                        )
                          return (l.contents = a(l.contents)), { value: l };
                      },
                      l = 0,
                      c = d;
                    l < c.length;
          ...
          (e.prototype.doesSupportMarkdown = function () {
            ...
            if (!a.isDefined(this.supportsMarkdown)) {
              if (!a.isDefined(this.lsOptions.clientCapabilities))
                return (this.supportsMarkdown = !0), this.supportsMarkdown;
              var r =
                null ===
                  (n =
              ...
              if ('/' === this._ch && '*' === this._input.peek()) {
                ...
                if ((this.preserveSingleSpace(i), '{' === this._input.peek()))
                  ...
                  k.match(/[ :]$/) &&
                    ...
                    this.print_string(k),
                    (this._output.space_before_token = !0)),
                    'extend' === (k = k.replace(/\s$/, '')) ? (v = !0) : 'import' === k && (_ = !0),
  ...
  (function (e) {
    ...
    t.format = function (e, t, c) {
      ...
      if (t) {
        ...
        var v = d.substring(0, m);
        if (new RegExp(/.*[<][^>]*$/).test(v)) return [{ range: t, newText: (d = d.substring(m, g)) }];
        if (((h = g === d.length), (d = d.substring(m, g)), 0 !== m)) {
          var _ = e.offsetAt(n.Position.create(t.start.line, 0));
          u = (function (e, t, n) {
            var i = t,
              r = 0,
              a = n.tabSize || 4;
...
!(function (e) {
    ...
    h = (function () {
      ...
      return (
        ...
        (e.parse = function (e, t) {
          void 0 === t && (t = !1);
          var n = d.exec(e);
          return n ? new p(n[2] || l, y(n[4] || l), y(n[5] || l), y(n[7] || l), y(n[9] || l), t) : new p(l, l, l, l, l);
        }),
        (e.file = function (e) {
          var t = l;
    ...
    p = (function (e) {
      ...
      return (
        ...
        (t.prototype.toString = function (e) {
          return (
            void 0 === e && (e = !1),
            e ? v(this, !0) : (this._formatted || (this._formatted = v(this, !1)), this._formatted)
          );
        }),
  ...
  (function (e) {
    ...
    t.findDocumentLinks = function (e, t) {
      ...
      for (var f = 0, g = i; f < g.length; f++) {
        var b = g[f],
          v = e.uri + '#';
        if (b.target && r.startsWith(b.target, v)) {
  ...
  (function (e) {
    ...
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.findOnTypeRenameRanges = void 0);
    var n = e('vscode-languageserver-types');
    t.findOnTypeRenameRanges = function (e, t, i) {
      var r = e.offsetAt(t),
        a = i.findNodeAt(r),
      ...
      return a.endTagStart &&
        ...
        ? [
            n.Range.create(e.positionAt(a.start + '<'.length), e.positionAt(a.start + '<'.length + o)),
            n.Range.create(e.positionAt(a.endTagStart + '</'.length), e.positionAt(a.endTagStart + '</'.length + o)),
          ]
        : null;
    };
  }),
        ...
        switch (s) {
          ...
          case i.TokenType.StartTagSelfClose:
            ...
            if (f >= 0) {
              var g = c[f];
              (c.length = f),
                (v = e.positionAt(o.getTokenOffset()).line - 1) > (m = g.startLine) &&
                  h !== m &&
                  u({ startLine: m, endLine: v });
            }
            break;
              ...
              if (b[1]) c.push({ startLine: m, tagName: '' });
                ...
                if (f >= 0) {
                  ...
                  (c.length = f),
                    (v = m) > (m = g.startLine) &&
                      h !== m &&
                      u({ startLine: m, endLine: v, kind: n.FoldingRangeKind.Region });
                }
              }
            else
              m < (v = e.positionAt(o.getTokenOffset() + o.getTokenLength()).line) &&
                u({ startLine: m, endLine: v, kind: n.FoldingRangeKind.Comment });
        }
        s = o.scan();
      }
        ...
        for (
          var i = (function (e, t) {
              ...
              return (
                ...
                s.start < a && a < s.startTagEnd
                  ? (l.unshift([s.start + 1, s.startTagEnd - 1]), (l = o(e, s, a).concat(l)))
                  : s.startTagEnd <= a && a <= s.endTagStart
...
!(function (e) {
  ...
  var n = e('./parser/htmlScanner'),
    ...
    u = e('./services/htmlSyncedRegions'),
  ...
  (t.getLanguageService = function (e) {
    ...
    return {
      ...
      findOnTypeRenameRanges: u.findOnTypeRenameRanges,
    };
  }),
  ...
  define('vs/language/html/languageFeatures', [
    ...
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.SelectionRangeAdapter = t.FoldingRangeAdapter = t.RenameAdapter = t.DocumentRangeFormattingEditProvider = t.DocumentFormattingEditProvider = t.DocumentLinkAdapter = t.DocumentSymbolAdapter = t.DocumentHighlightAdapter = t.HoverAdapter = t.CompletionAdapter = t.DiagnosticsAdapter = void 0);
    var r = (function () {
      function e(e, t, n) {
        var r = this;
          ...
          this._worker(e)
            .then(function (n) {
              return n.doValidation(e.toString()).then(function (n) {
                ...
                i.editor.setModelMarkers(i.editor.getModel(e), t, r);
              });
            })
            ...
            .then(function (r) {
              if (r) {
                var a = e.getWordUntilPosition(t),
                  o = new i.Range(t.lineNumber, a.startColumn, t.lineNumber, a.endColumn),
                    ...
                    return (
                      e.textEdit &&
                        (void 0 !== (t = e.textEdit).insert && void 0 !== t.replace
                          ? (r.range = { insert: s(e.textEdit.insert), replace: s(e.textEdit.replace) })
                          : (r.range = s(e.textEdit.range)),
                        (r.insertText = e.textEdit.newText)),
                      e.additionalTextEdits && (r.additionalTextEdits = e.additionalTextEdits.map(c)),
                      e.insertTextFormat === n.InsertTextFormat.Snippet &&
                        (r.insertTextRules = i.languages.CompletionItemInsertTextRule.InsertAsSnippet),
                      r
                    );
                  });
      ...
      return (
        (e.prototype.provideDocumentFormattingEdits = function (e, t, n) {
          ...
          return this._worker(i).then(function (e) {
            return e.format(i.toString(), null, _(t)).then(function (e) {
            ...
            .then(function (e) {
              return (function (e) {
                ...
                for (var n in e.changes)
                  for (var r = i.Uri.parse(n), a = 0, o = e.changes[n]; a < o.length; a++) {
                    var l = o[a];
                    t.push({ resource: r, edit: { range: s(l.range), text: l.newText } });
                  }
                return { edits: t };
              })(e);
            });
        ...
        (e.prototype.provideSelectionRanges = function (e, t, n) {
          ...
          return this._worker(i)
            ...
            .then(function (e) {
              if (e)
                return e.map(function (e) {
                  for (var t = []; e; ) t.push({ range: s(e.range) }), (e = e.parent);
                  return t;
                });
            });
        }),
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.setupMode1 = function (e) {
        ...
        r.languages.registerCompletionItemProvider(o, new i.CompletionAdapter(a)),
          ...
          'html' === o &&
            (r.languages.registerDocumentFormattingEditProvider(o, new i.DocumentFormattingEditProvider(a)),
            r.languages.registerDocumentRangeFormattingEditProvider(o, new i.DocumentRangeFormattingEditProvider(a)),
      ...
      (t.setupMode = function (e) {
        ...
        return (
          ...
          o(s),
          d.completionItems && s.push(r.languages.registerCompletionItemProvider(c, new i.CompletionAdapter(h))),
          d.hovers && s.push(r.languages.registerHoverProvider(c, new i.HoverAdapter(h))),
          d.documentHighlights &&
            s.push(r.languages.registerDocumentHighlightProvider(c, new i.DocumentHighlightAdapter(h))),
          d.links && s.push(r.languages.registerLinkProvider(c, new i.DocumentLinkAdapter(h))),
          d.documentSymbols && s.push(r.languages.registerDocumentSymbolProvider(c, new i.DocumentSymbolAdapter(h))),
          d.rename && s.push(r.languages.registerRenameProvider(c, new i.RenameAdapter(h))),
          d.foldingRanges && s.push(r.languages.registerFoldingRangeProvider(c, new i.FoldingRangeAdapter(h))),
          d.selectionRanges && s.push(r.languages.registerSelectionRangeProvider(c, new i.SelectionRangeAdapter(h))),
          d.documentFormattingEdits &&
            s.push(r.languages.registerDocumentFormattingEditProvider(c, new i.DocumentFormattingEditProvider(h))),
          d.documentRangeFormattingEdits &&
            s.push(
              r.languages.registerDocumentRangeFormattingEditProvider(c, new i.DocumentRangeFormattingEditProvider(h))
            ),
