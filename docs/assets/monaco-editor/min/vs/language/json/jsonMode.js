...
define('vs/language/json/workerManager', ['require', 'exports', './fillers/monaco-editor-core'], function (e, t, n) {
  ...
  (function (e) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.createScanner = function (e, t) {
        ...
        function g() {
          if (((s = ''), (m = 0), (c = a), (l = f), (p = d), a >= i)) return (c = i), (u = 17);
          ...
          switch (t) {
            ...
            case 47:
              ...
              if (42 === e.charCodeAt(a + 1)) {
                ...
                return b || (a++, (m = 1)), (s = e.substring(g, a)), (u = 13);
              }
              ...
              return (
                (s += (function () {
                  ...
                  if (a < e.length && 46 === e.charCodeAt(a)) {
                    if (!(++a < e.length && o(e.charCodeAt(a)))) return (m = 3), e.substring(t, a);
  ...
  (function (e) {
    ...
    (t.format = function (e, t, i) {
      ...
      function b() {
        var e = g.scan();
        for (m = !1; 15 === e || 14 === e; ) (m = m || 14 === e), (e = g.scan());
      ...
      for (; 17 !== C; ) {
        for (var k = g.getTokenOffset() + g.getTokenLength() + c, j = b(), E = ''; !m && (12 === j || 13 === j); ) {
          S(' ', k, g.getTokenOffset() + c),
            (k = g.getTokenOffset() + g.getTokenLength() + c),
            (E = 12 === j ? y() : ''),
            (j = b());
        }
        if (2 === j) 1 !== C && (h--, (E = y()));
        else if (4 === j) 3 !== C && (h--, (E = y()));
        else {
          switch (C) {
            case 3:
            case 1:
          ...
          case 3:
            return (function () {
              ...
              for (var e = !1; 4 !== i.getToken() && 17 !== i.getToken(); ) {
                if (5 === i.getToken()) {
                  if ((e || x(4, [], []), m(','), b(), 4 === i.getToken() && y)) break;
                } else e && x(6, [], []);
                C() || x(4, [], [4, 5]), (e = !0);
              }
          ...
          case 1:
            return (function () {
              ...
              for (var e = !1; 2 !== i.getToken() && 17 !== i.getToken(); ) {
                if (5 === i.getToken()) {
                  if ((e || x(4, [], []), m(','), b(), 2 === i.getToken() && y)) break;
                } else e && x(6, [], []);
                (10 !== i.getToken()
                  ? (x(3, [], [2, 5]), 0)
                  : (S(!1), 6 === i.getToken() ? (m(':'), b(), C() || x(4, [], [2, 5])) : x(5, [], [2, 5]), 1)) ||
                  x(4, [], [2, 5]),
                  (e = !0);
              }
  ...
  (function (e) {
    ...
    function o(e, t, n, o) {
      for (
        ...
        s.length > 0 && ((f = s.pop()), void 0 === (u = r.findNodeAtLocation(c, s)) && void 0 !== n);
      ...
      if (u) {
        if ('object' === u.type && 'string' == typeof f && Array.isArray(u.children)) {
          ...
          if (void 0 !== l) {
            if (void 0 === n) {
              ...
              else if (((p = u.offset + 1), u.children.length > 1)) m = u.children[1].offset;
              return i(e, { offset: p, length: m - p, content: '' }, o);
            }
            return i(e, { offset: l.offset, length: l.length, content: JSON.stringify(n) }, o);
          }
          if (void 0 === n) return [];
          var h = JSON.stringify(f) + ': ' + JSON.stringify(n),
            g = void 0;
          return i(
            e,
            (g =
              (T = o.getInsertionIndex
                ...
                : u.children.length) > 0
                ? { offset: (C = u.children[T - 1]).offset + C.length, length: 0, content: ',' + h }
                : 0 === u.children.length
        ...
        if ('array' === u.type && 'number' == typeof f && Array.isArray(u.children)) {
          var v = f;
          if (-1 === v) {
            (h = '' + JSON.stringify(n)), (g = void 0);
            if (0 === u.children.length) g = { offset: u.offset + 1, length: 0, content: h };
            else g = { offset: (C = u.children[u.children.length - 1]).offset + C.length, length: 0, content: ',' + h };
            return i(e, g, o);
          }
          if (void 0 === n && u.children.length >= 0) {
            var y = f,
              b = u.children[y];
            g = void 0;
            if (1 === u.children.length) g = { offset: u.offset + 1, length: u.length - 2, content: '' };
            else if (u.children.length - 1 === y) {
              var x = (C = u.children[y - 1]).offset + C.length;
              g = { offset: x, length: u.offset + u.length - 2 - x, content: '' };
            } else g = { offset: b.offset, length: u.children[y + 1].offset - b.offset, content: '' };
            return i(e, g, o);
          }
          if (void 0 !== n) {
            (g = void 0), (h = '' + JSON.stringify(n));
            if (!o.isArrayInsertion && u.children.length > f) {
              var S = u.children[f];
              g = { offset: S.offset, length: S.length, content: h };
            } else if (0 === u.children.length || 0 === f)
              g = { offset: u.offset + 1, length: 0, content: 0 === u.children.length ? h : h + ',' };
            else {
              var C,
                T = f > u.children.length ? u.children.length : f;
              g = { offset: (C = u.children[T - 1]).offset + C.length, length: 0, content: ',' + h };
            }
            return i(e, g, o);
          }
          throw new Error(
        ...
        throw new Error(
          'Can not add ' + ('number' != typeof f ? 'index' : 'property') + ' to parent of type ' + u.type
        );
      }
      if (void 0 === n) throw new Error('Can not delete in empty document');
      return i(e, { offset: c ? c.offset : 0, length: c ? c.length : 0, content: JSON.stringify(n) }, o);
    }
    function i(e, t, r) {
      ...
      for (var c = n.format(o, { offset: i, length: s - i }, r.formattingOptions), u = c.length - 1; u >= 0; u--) {
        var f = c[u];
        (o = a(o, f)),
          ...
          for (var i = 0, a = t; i < a.length; i++) {
            ...
            if (e.isIncremental(s)) {
              ...
              var l = Math.max(c.start.line, 0),
                ...
                p = this._lineOffsets,
                m = r(s.text, !1, u);
              if (d - l === m.length) for (var h = 0, g = m.length; h < g; h++) p[h + l + 1] = m[h];
              else
                m.length < 1e4
                  ? p.splice.apply(p, [l + 1, d - l].concat(m))
                  : (this._lineOffsets = p = p.slice(0, l + 1).concat(m, p.slice(d + 1)));
              var v = s.text.length - (f - u);
              if (0 !== v) for (h = l + 1 + m.length, g = p.length; h < g; h++) p[h] = p[h] + v;
            } else {
      ...
      (e.create = function (e, t, r, o) {
        ...
        (e.applyEdits = function (e, t) {
          for (
            ...
            var c = s[a],
              u = e.offsetAt(c.range.start);
            if (u < r) throw new Error('Overlapping edit');
            u > r && o.push(n.substring(r, u)), c.newText.length && o.push(c.newText), (r = e.offsetAt(c.range.end));
          }
...
!(function (e) {
    ...
    if (e && s.include(e)) {
        ...
        case 'object':
          !(function (e, t, n, a) {
            for (var s = Object.create(null), c = [], u = 0, f = e.properties; u < f.length; u++) {
              (s[(J = (T = f[u]).keyNode.value)] = T.valueNode), c.push(J);
            }
            if (Array.isArray(t.required))
              for (var l = 0, d = t.required; l < d.length; l++) {
                if (!s[(_ = d[l])]) {
                  var p = e.parent && 'property' === e.parent.type && e.parent.keyNode,
                    m = p ? { offset: p.offset, length: p.length } : { offset: e.offset, length: 1 };
                  n.problems.push({
                    location: m,
                    severity: o.DiagnosticSeverity.Warning,
                    message: i('MissingRequiredPropWarning', 'Missing property "{0}".', _),
                  });
                }
              }
            var g = function (e) {
            ...
            if (t.properties)
              for (var b = 0, x = Object.keys(t.properties); b < x.length; b++) {
                g((_ = x[b]));
                var S = t.properties[_];
                if ((R = s[_]))
                  if (r.isBoolean(S))
                    if (S) n.propertiesMatches++, n.propertiesValueMatches++;
                      ...
                      n.problems.push({
                        ...
                        severity: o.DiagnosticSeverity.Warning,
                        message: t.errorMessage || i('DisallowedExtraPropWarning', 'Property {0} is not allowed.', _),
                      });
                    }
                  else C(R, S, (P = new y()), a), n.mergePropertyMatch(P);
              }
            if (t.patternProperties)
              for (var k = 0, j = Object.keys(t.patternProperties); k < j.length; k++)
                for (var E = j[k], O = new RegExp(E), A = 0, I = c.slice(0); A < I.length; A++) {
                  var _ = I[A];
                  if (O.test(_))
                    if ((g(_), (R = s[_]))) {
                      S = t.patternProperties[E];
                      if (r.isBoolean(S))
                        if (S) n.propertiesMatches++, n.propertiesValueMatches++;
                        else {
                          T = R.parent;
                          n.problems.push({
                            ...
                            severity: o.DiagnosticSeverity.Warning,
                            message:
                              t.errorMessage || i('DisallowedExtraPropWarning', 'Property {0} is not allowed.', _),
                          });
                        }
                      else C(R, S, (P = new y()), a), n.mergePropertyMatch(P);
                    }
            ...
            if ('object' == typeof t.additionalProperties)
              for (var w = 0, N = c; w < N.length; w++) {
                if ((R = s[(_ = N[w])])) {
                  var P = new y();
                  C(R, t.additionalProperties, P, a), n.mergePropertyMatch(P);
                }
              }
            ...
            if (t.dependencies)
              for (var F = 0, L = Object.keys(t.dependencies); F < L.length; F++) {
                if (s[(J = L[F])]) {
                  var V = t.dependencies[J];
                  if (Array.isArray(V))
                    for (var K = 0, $ = V; K < $.length; K++) {
                      var q = $[K];
                      s[q]
                  ...
                  else if ((S = h(V))) C(e, S, (P = new y()), a), n.mergePropertyMatch(P);
                }
              }
            var W = h(t.propertyNames);
            if (W)
              for (var U = 0, B = e.properties; U < B.length; U++) {
                var J;
                (J = B[U].keyNode) && C(J, W, n, v.instance);
              }
          })(c, t, n, s);
          break;
        case 'array':
          !(function (e, t, n, a) {
            if (Array.isArray(t.items)) {
              ...
              var d = h(t.items);
              if (d)
                for (var p = 0, m = e.items; p < m.length; p++) {
                  var g;
                  C((g = m[p]), d, (f = new y()), a), n.mergePropertyMatch(f);
                }
            }
            var x = h(t.contains);
            if (x) {
        ...
        case 'number':
          !(function (e, t, n, a) {
            ...
            if (r.isNumber(t.multipleOf)) {
              var u = -1;
              if (Number.isInteger(t.multipleOf)) u = s % t.multipleOf;
              else {
                var f = c(t.multipleOf),
                  l = c(s);
                if (f && l) {
                  var d = Math.pow(10, Math.abs(l.multiplier - f.multiplier));
                  l.multiplier < f.multiplier ? (l.value *= d) : (f.value *= d), (u = l.value % f.value);
                }
              }
              0 !== u &&
                n.problems.push({
            ...
            var h = p(t.minimum, t.exclusiveMinimum);
            r.isNumber(h) &&
              s <= h &&
              n.problems.push({
                location: { offset: e.offset, length: e.length },
            ...
            var g = p(t.maximum, t.exclusiveMaximum);
            r.isNumber(g) &&
              s >= g &&
              n.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: o.DiagnosticSeverity.Warning,
                message: i('exclusiveMaximumWarning', 'Value is above the exclusive maximum of {0}.', g),
              });
            var v = m(t.minimum, t.exclusiveMinimum);
            r.isNumber(v) &&
              s < v &&
              n.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: o.DiagnosticSeverity.Warning,
                message: i('minimumWarning', 'Value is below the minimum of {0}.', v),
              });
            var y = m(t.maximum, t.exclusiveMaximum);
            r.isNumber(y) &&
              s > y &&
              n.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: o.DiagnosticSeverity.Warning,
                message: i('maximumWarning', 'Value is above the maximum of {0}.', y),
              });
          })(c, t, n);
          break;
        case 'property':
      ...
      !(function () {
        ...
        if (l) {
          ...
          for (var m = 0, g = p.schemas; m < g.length; m++) {
            var v = g[m];
            (v.inverted = !v.inverted), s.add(v);
          }
        }
        var x = function (e, t) {
          for (var r = [], a = void 0, u = 0, f = e; u < f.length; u++) {
            var l = h(f[u]),
              d = new y(),
              p = s.newSub();
            if ((C(c, l, d, p), d.hasProblems() || r.push(l), a))
              if (t || d.hasProblems() || a.validationResult.hasProblems()) {
                var m = d.compare(a.validationResult);
                m > 0
                  ? (a = { schema: l, validationResult: d, matchingSchemas: p })
                  : 0 === m && (a.matchingSchemas.merge(p), a.validationResult.mergeEnumValues(d));
              } else
                a.matchingSchemas.merge(p),
                  (a.validationResult.propertiesMatches += d.propertiesMatches),
                  (a.validationResult.propertiesValueMatches += d.propertiesValueMatches);
            else a = { schema: l, validationResult: d, matchingSchemas: p };
          }
          return (
            r.length > 1 &&
              t &&
        ...
        if (Array.isArray(t.enum)) {
          for (var k = b(c), j = !1, E = 0, O = t.enum; E < O.length; E++) {
            var A = O[E];
            if (r.equals(k, A)) {
              j = !0;
              break;
  ...
  (t.JSONDocument = S),
    (t.parse = function (e, t) {
      ...
      var k = new d(void 0, 0, 0);
      function j(t, n) {
        var r = new p(t, g.getTokenOffset(), k),
          a = E(r);
        if (!a) {
          ...
          (function (e) {
            if (3 === g.getToken()) {
              ...
              for (var n = !1; 4 !== g.getToken() && 17 !== g.getToken(); ) {
                ...
                a
                  ? t.items.push(a)
                  : x(i('PropertyExpected', 'Value expected'), o.ErrorCode.ValueExpected, void 0, [], [4, 5]),
                  (n = !0);
              }
              return 4 !== g.getToken()
                ? x(
          ...
          (function (e) {
            if (1 === g.getToken()) {
              ...
              for (var r = !1; 2 !== g.getToken() && 17 !== g.getToken(); ) {
                ...
                s
                  ? t.properties.push(s)
                  : x(i('PropertyExpected', 'Property expected'), o.ErrorCode.PropertyExpected, void 0, [], [2, 5]),
                  (r = !0);
              }
              return 2 !== g.getToken()
                ? x(
              ...
              h = {
                add: function (e) {
                  ...
                  if (n) n.documentation || (n.documentation = e.documentation);
                    ...
                    l && void 0 !== e.insertText && (e.textEdit = s.TextEdit.replace(l, e.insertText)),
                      (e.label = t),
                      (m[t] = e),
                      i.items.push(e);
                  }
            ...
            return this.schemaService.getSchemaForResource(e.uri, r).then(function (t) {
              ...
              if (u && 'object' === u.type) {
                ...
                u.properties.forEach(function (e) {
                  (v && v === e) || (m[e.keyNode.value] = s.CompletionItem.create('__'));
                });
                var b = '';
                p && (b = o.evaluateSeparatorAfter(e, e.offsetAt(l.end))),
                  t ? o.getPropertyCompletions(t, r, u, p, b, h) : o.getSchemaLessPropertyCompletions(r, u, g, h);
                var x = n.getNodePath(u);
                o.contributions.forEach(function (t) {
                  var n = t.collectPropertyCompletions(e.uri, x, d, p, '' === b, h);
                  n && f.push(n);
                }),
                  !t &&
                    d.length > 0 &&
              ...
              var S = {};
              return (
                t ? o.getValueCompletions(t, r, u, c, e, h, S) : o.getSchemaLessValueCompletions(r, u, c, e, h),
                o.contributions.length > 0 && o.getContributedValueCompletions(r, u, c, e, h, f),
                o.promiseConstructor.all(f).then(function () {
                  if (0 === h.getNumberOfProposals()) {
                    ...
                    o.addFillerValueCompletions(S, n, h);
                  }
                  return i;
                })
              );
                  ...
                  if (u.enum)
                    for (var l = 0; l < u.enum.length; l++) {
                      ...
                      u.markdownEnumDescriptions && l < u.markdownEnumDescriptions.length
                        ...
                        : u.enumDescriptions && l < u.enumDescriptions.length && (d = u.enumDescriptions[l]),
                        f(u.enum[l], d);
                    }
                  u.const && f(u.const);
                }
          ...
          (e.prototype.getValueCompletions = function (e, t, n, r, o, i, a) {
            ...
            if (
              ...
              if (n && (void 0 !== c || 'array' === n.type)) {
                for (
                  var l = this.evaluateSeparatorAfter(o, s), d = 0, p = t.getMatchingSchemas(e.schema, n.offset, u);
                  d < p.length;
                  d++
                ) {
                  var m = p[d];
                  if (m.node === n && !m.inverted && m.schema) {
                    if ('array' === n.type && m.schema.items)
                      if (Array.isArray(m.schema.items)) {
                        var h = this.findItemAtOffset(n, o, r);
                        h < m.schema.items.length && this.addSchemaValueCompletions(m.schema.items[h], l, i, a);
                      } else this.addSchemaValueCompletions(m.schema.items, l, i, a);
                    if (void 0 !== c) {
                      var g = !1;
                      if (m.schema.properties)
                        (x = m.schema.properties[c]) && ((g = !0), this.addSchemaValueCompletions(x, l, i, a));
                      if (m.schema.patternProperties && !g)
                        for (var v = 0, y = Object.keys(m.schema.patternProperties); v < y.length; v++) {
                          var b = y[v];
                          if (new RegExp(b).test(c)) {
                            g = !0;
                            var x = m.schema.patternProperties[b];
                            this.addSchemaValueCompletions(x, l, i, a);
                          }
                        }
                      if (m.schema.additionalProperties && !g) {
                        x = m.schema.additionalProperties;
                        this.addSchemaValueCompletions(x, l, i, a);
                      }
                    }
                  }
                ...
                '$schema' !== c || n.parent || this.addDollarSchemaCompletions(l, i),
                  a.boolean && (this.addBooleanValueCompletion(!0, l, i), this.addBooleanValueCompletion(!1, l, i)),
        ...
        return (
          (e.prototype.doHover = function (e, t, o) {
            ...
            for (
              ...
              var m = this.contributions[p].getInfoContribution(e.uri, d);
              if (m)
...
!(function (e) {
    ...
    l = (function () {
      ...
      return (
        ...
        (e.parse = function (e, t) {
          void 0 === t && (t = !1);
          var n = f.exec(e);
          return n ? new p(n[2] || c, x(n[4] || c), x(n[5] || c), x(n[7] || c), x(n[9] || c), t) : new p(c, c, c, c, c);
        }),
        (e.file = function (e) {
          var t = c;
  ...
  function g(e) {
    for (var t = void 0, n = 0; n < e.length; n++) {
      ...
      35 === r || 63 === r ? (void 0 === t && (t = e.substr(0, n)), (t += m[r])) : void 0 !== t && (t += e[n]);
    }
    return void 0 !== t ? t : e;
  }
  function v(e, t) {
  ...
  function y(e, t) {
    ...
    return s && ((r += '?'), (r += n(s, !1))), c && ((r += '#'), (r += t ? c : h(c, !1))), r;
  }
  t.uriToFsPath = v;
      ...
      return (
        ...
        (e.prototype.loadSchema = function (e) {
          ...
          return this.requestService(e).then(
            function (t) {
              if (!t) {
                var r = a('json.schema.nocontent', "Unable to load schema from '{0}': No content.", m(e));
                return new u({}, [r]);
              }
              var o,
                i = [];
            ...
            function (t) {
              ...
              return (
                ...
                new u({}, [a('json.schema.nocontent', "Unable to load schema from '{0}': {1}.", m(e), n)])
              );
            }
          );
        }),
        (e.prototype.resolveSchemaContent = function (e, t, n) {
          ...
          if (i.$schema) {
            ...
            'https://json-schema.org/draft/2019-09/schema' === s &&
              o.push(a('json.schema.draft201909.notsupported', 'Draft 2019-09 schemas are not yet fully supported.'));
          }
        ...
        (e.prototype.getSchemaForResource = function (e, t) {
          ...
          for (var c = Object.create(null), u = [], f = 0, l = this.filePatternAssociations; f < l.length; f++) {
            var d = l[f];
            if (d.matchesPattern(e))
              for (var m = 0, h = d.getURIs(); m < h.length; m++) {
                var g = h[m];
                c[g] || (u.push(g), (c[g] = !0));
              }
          }
          var v = u.length > 0 ? this.createCombinedSchema(e, u).getResolvedSchema() : this.promise.resolve(void 0);
          return (this.cachedSchemaForResource = { resource: e, resolvedSchema: v }), v;
        }),
      ...
      s = (function () {
        ...
        return (
          ...
          (e.prototype.doValidation = function (e, t, o, s) {
              ...
              m = function (n) {
                ...
                if (n) {
                  if (n.errors.length && t.root) {
                    var d = t.root,
                      m = 'object' === d.type ? d.properties[0] : void 0;
                    if (m && '$schema' === m.keyNode.value) {
                      var h = m.valueNode || m,
                        g = r.Range.create(e.positionAt(h.offset), e.positionAt(h.offset + h.length));
                      p(
                        r.Diagnostic.create(
                          g,
                          n.errors[0],
                  ...
                  (function e(t) {
                    ...
                    (function e(t) {
                      if (t && 'object' == typeof t) {
                        ...
                        var n = t;
                        if (i.isBoolean(n.allowsTrailingCommas)) return n.allowsTrailingCommas;
                        if (t.allOf)
            ...
            if (s) {
              var h = s.id || 'schemaservice://untitled/' + c++;
              return this.jsonSchemaService.resolveSchemaContent(new n.UnresolvedSchema(s), h, {}).then(function (e) {
                return m(e);
              });
            }
  ...
  (function (e) {
    ...
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.colorFrom256RGB = t.colorFromHex = t.hexDigit = void 0);
    function n(e) {
      ...
      a = (function () {
        ...
        return (
          (e.prototype.findDocumentSymbols = function (e, t, o) {
            ...
            if (
              ...
              for (var l = [], d = 0, p = c.items; d < p.length; d++) {
                var m = p[d];
                if ('object' === m.type)
                  for (var h = 0, g = m.properties; h < g.length; h++) {
                    var v = g[h];
                    if ('key' === v.keyNode.value && v.valueNode) {
                      var y = i.Location.create(e.uri, s(e, m));
                      if (
          ...
          (e.prototype.findDocumentSymbols2 = function (e, t, o) {
            ...
            return T && o && o.onResultLimitExceeded && o.onResultLimitExceeded(f), x;
          }),
              ...
              if (i)
                for (
                  ...
                  if (
                    ...
                    if (!u[p]) {
                      var m = o.colorFromHex(n.getNodeValue(d.node));
                      if (m) {
                        var h = s(e, d.node);
                        a.push({ color: m, range: h });
                      }
                      if (((u[p] = !0), --c <= 0))
    ...
    t.getFoldingRanges = function (e, t) {
      ...
      for (; 17 !== u; ) {
        switch (u) {
          ...
          case 3:
            var l = {
              startLine: (m = e.positionAt(c.getTokenOffset()).line),
              endLine: m,
          ...
          case 4:
            ...
            break;
          case 13:
            var m = e.positionAt(c.getTokenOffset()).line,
              h = e.positionAt(c.getTokenOffset() + c.getTokenLength()).line;
            1 === c.getTokenError() && m + 1 < e.lineCount
              ? c.setPosition(e.offsetAt(r.Position.create(m + 1, 0)))
              : m < h && (f({ startLine: m, endLine: h, kind: r.FoldingRangeKind.Comment }), (s = m));
            break;
          case 12:
            var g = e
              .getText()
      ...
      for (v = 0; v < o.length; v++) {
        var E;
        'number' == typeof (E = i[v]) && (E < T || (E === T && C++ < y)) && j.push(o[v]);
      }
      return j;
    };
  }),
  ...
  (function (e) {
    ...
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.findDefinition = void 0);
    var n = e('../jsonLanguageTypes');
    function r(e, t) {
      return n.Range.create(e.positionAt(t.offset), e.positionAt(t.offset + t.length));
    }
    function o(e) {
      return e.replace(/~1/g, '/').replace(/~0/g, '~');
    }
    t.findDefinition = function (e, t, n) {
      var i = e.offsetAt(t),
        a = n.getNodeFromOffset(i, !0);
      if (
        !a ||
        !(function (e) {
          return (
      ...
      var s = a.parent.valueNode,
        c = (function (e, t) {
          var n = (function (e) {
            if ('#' === e) return [];
            if ('#' !== e[0] || '/' !== e[1]) return null;
            return e.substring(2).split(/\//).map(o);
          })(t);
          if (!n) return null;
      ...
      var u = { targetUri: e.uri, originSelectionRange: r(e, s), targetRange: r(e, c), targetSelectionRange: r(e, c) };
...
!(function (e) {
  ...
  var n = e('./services/jsonCompletion'),
    ...
    p = e('./services/jsonDefinition');
  __exportStar(e('./jsonLanguageTypes'), t),
    (t.getLanguageService = function (e) {
      var t = e.promiseConstructor || Promise,
        m = new c.JSONSchemaService(e.schemaRequestService, e.workspaceContext, t);
      m.setSchemaContributions(s.schemaContributions);
      var h = new n.JSONCompletion(m, e.contributions, t, e.clientCapabilities),
        g = new r.JSONHover(m, e.contributions, t),
        v = new i.JSONDocumentSymbols(m),
        y = new o.JSONValidation(m, t);
      return {
        configure: function (e) {
          m.clearExternalSchemas(),
            e.schemas &&
              e.schemas.forEach(function (e) {
                m.registerExternalSchema(e.uri, e.fileMatch, e.schema);
              }),
            y.configure(e);
        },
        resetSchema: function (e) {
          return m.onResourceChange(e);
        },
        ...
        getMatchingSchemas: m.getMatchingSchemas.bind(m),
        ...
        findColorSymbols: function (e, t) {
          return v.findDocumentColors(e, t).then(function (e) {
        ...
        findDefinition: p.findDefinition,
                    ...
                    return (
                      e.textEdit &&
                        (void 0 !== (t = e.textEdit).insert && void 0 !== t.replace
                          ? (o.range = { insert: c(e.textEdit.insert), replace: c(e.textEdit.replace) })
                          : (o.range = c(e.textEdit.range)),
                        (o.insertText = e.textEdit.newText)),
                      e.additionalTextEdits && (o.additionalTextEdits = e.additionalTextEdits.map(f)),
                      e.insertTextFormat === r.InsertTextFormat.Snippet &&
                        (o.insertTextRules = n.languages.CompletionItemInsertTextRule.InsertAsSnippet),
                      o
                    );
                  });
        ...
        return {
          ...
          tokenize: function (i, a, s, c) {
            return (function (e, i, a, s, c) {
              ...
              var l = n.createScanner(i),
                d = a.lastWasColon,
                p = a.parents,
                m = { tokens: [], endState: a.clone() };
              for (;;) {
                var h = s + l.getPosition(),
                  g = '',
                  v = l.scan();
                if (17 === v) break;
                if (h === s + l.getPosition())
                  throw new Error('Scanner did not advance, next 3 characters are: ' + i.substr(l.getPosition(), 3));
                switch ((f && (h -= u), (f = u > 0), v)) {
                  case 1:
                ...
                (m.endState = new o(a.getStateData(), l.getTokenError(), d, p)),
                  m.tokens.push({ startIndex: h, scopes: g });
              }
              return m;
            })(e, i, a, s);
          },
  ...
  define('vs/language/json/jsonMode', [
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.setupMode = function (e) {
        var t = [],
          u = [],
          f = new n.WorkerManager(e);
        t.push(f);
        var l = function () {
          for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
          return f.getLanguageServiceWorker.apply(f, e);
        };
        function d() {
          var t = e.languageId,
          ...
          s(u),
            n.documentFormattingEdits &&
              u.push(i.languages.registerDocumentFormattingEditProvider(t, new r.DocumentFormattingEditProvider(l))),
            n.documentRangeFormattingEdits &&
              u.push(
                i.languages.registerDocumentRangeFormattingEditProvider(t, new r.DocumentRangeFormattingEditProvider(l))
              ),
            n.completionItems && u.push(i.languages.registerCompletionItemProvider(t, new r.CompletionAdapter(l))),
            n.hovers && u.push(i.languages.registerHoverProvider(t, new r.HoverAdapter(l))),
            n.documentSymbols && u.push(i.languages.registerDocumentSymbolProvider(t, new r.DocumentSymbolAdapter(l))),
            n.tokens && u.push(i.languages.setTokensProvider(t, o.createTokenizationSupport(!0))),
            n.colors && u.push(i.languages.registerColorProvider(t, new r.DocumentColorAdapter(l))),
            n.foldingRanges && u.push(i.languages.registerFoldingRangeProvider(t, new r.FoldingRangeAdapter(l))),
            n.diagnostics && u.push(new r.DiagnosticsAdapter(t, l, e)),
            n.selectionRanges && u.push(i.languages.registerSelectionRangeProvider(t, new r.SelectionRangeAdapter(l)));
        }
