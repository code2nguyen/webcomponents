...
!(function (e) {
  ...
  (function (e) {
    ...
    (t.format = function (e, t, i) {
      ...
      var j = b();
      if (17 !== j) {
        var C = g.getTokenOffset() + c;
        S(r(d, a), c, C);
      }
      for (; 17 !== j; ) {
        for (var T = g.getTokenOffset() + g.getTokenLength() + c, O = b(), k = ''; !h && (12 === O || 13 === O); ) {
          ...
          case 1:
            return (function () {
              ...
              for (var e = !1; 2 !== i.getToken() && 17 !== i.getToken(); ) {
                ...
                (10 !== i.getToken()
                  ? (x(3, [], [2, 5]), 0)
                  : (S(!1), 6 === i.getToken() ? (h(':'), b(), j() || x(4, [], [2, 5])) : x(5, [], [2, 5]), 1)) ||
                  x(4, [], [2, 5]),
                  (e = !0);
              }
      ...
      if (u) {
        if ('object' === u.type && 'string' == typeof f && Array.isArray(u.children)) {
          ...
          if (void 0 !== l) {
            if (void 0 === n) {
              ...
              if (d > 0) p = (j = u.children[d - 1]).offset + j.length;
          ...
          return i(
            ...
            (g =
              (C = o.getInsertionIndex
                ...
                : u.children.length) > 0
                ? { offset: (j = u.children[C - 1]).offset + j.length, length: 0, content: ',' + m }
                : 0 === u.children.length
        ...
        if ('array' === u.type && 'number' == typeof f && Array.isArray(u.children)) {
          ...
          if (-1 === v) {
            ...
            else g = { offset: (j = u.children[u.children.length - 1]).offset + j.length, length: 0, content: ',' + m };
            return i(e, g, o);
          }
          if (void 0 === n && u.children.length >= 0) {
            ...
            if (1 === u.children.length) g = { offset: u.offset + 1, length: u.length - 2, content: '' };
              ...
              var x = (j = u.children[y - 1]).offset + j.length;
          ...
          if (void 0 !== n) {
            ...
            if (!o.isArrayInsertion && u.children.length > f) {
              ...
              g = { offset: u.offset + 1, length: 0, content: 0 === u.children.length ? m : m + ',' };
            else {
              var j,
                C = f > u.children.length ? u.children.length : f;
              g = { offset: (j = u.children[C - 1]).offset + j.length, length: 0, content: ',' + m };
            }
            return i(e, g, o);
          }
          throw new Error(
  ...
  var S = (function () {
    ...
    return (
      ...
      (e.prototype.getMatchingSchemas = function (e, t, n) {
        void 0 === t && (t = -1);
        var r = new g(t, n);
        return this.root && e && j(this.root, e, new y(), r), r.schemas;
      }),
      e
    );
  })();
      ...
      switch (c.type) {
          ...
          !(function (e, t, n, a) {
              ...
              for (var l = 0, d = t.required; l < d.length; l++) {
                if (!s[(P = d[l])]) {
                  ...
                  n.problems.push({
                    ...
                    message: i('MissingRequiredPropWarning', 'Missing property "{0}".', P),
                  });
                }
              }
            var g = function (e) {
                  ...
                  if (r.isBoolean(S))
                    if (S) n.propertiesMatches++, n.propertiesValueMatches++;
                      ...
                      n.problems.push({
                        ...
                        severity: o.DiagnosticSeverity.Warning,
                        message: t.errorMessage || i('DisallowedExtraPropWarning', 'Property {0} is not allowed.', P),
                      });
                    }
                  else j(F, S, (N = new y()), a), n.mergePropertyMatch(N);
              }
            if (t.patternProperties)
              for (var T = 0, O = Object.keys(t.patternProperties); T < O.length; T++)
                for (var k = O[T], A = new RegExp(k), E = 0, I = c.slice(0); E < I.length; E++) {
                  var P = I[E];
                  if (A.test(P))
                    if ((g(P), (F = s[P]))) {
                      ...
                      if (r.isBoolean(S))
                        if (S) n.propertiesMatches++, n.propertiesValueMatches++;
                          ...
                          n.problems.push({
                            ...
                            severity: o.DiagnosticSeverity.Warning,
                            message:
                              t.errorMessage || i('DisallowedExtraPropWarning', 'Property {0} is not allowed.', P),
                          });
                        }
                      else j(F, S, (N = new y()), a), n.mergePropertyMatch(N);
                    }
            ...
            if ('object' == typeof t.additionalProperties)
              for (var w = 0, _ = c; w < _.length; w++) {
                if ((F = s[(P = _[w])])) {
                  var N = new y();
                  j(F, t.additionalProperties, N, a), n.mergePropertyMatch(N);
                }
              }
            ...
            if (t.dependencies)
              for (var R = 0, V = Object.keys(t.dependencies); R < V.length; R++) {
                if (s[(J = V[R])]) {
                  var L = t.dependencies[J];
                  if (Array.isArray(L))
                    for (var $ = 0, q = L; $ < q.length; $++) {
                      var W = q[$];
                      s[W]
                  ...
                  else if ((S = m(L))) j(e, S, (N = new y()), a), n.mergePropertyMatch(N);
                }
              }
            var U = m(t.propertyNames);
            if (U)
              for (var K = 0, B = e.properties; K < B.length; K++) {
                var J;
                (J = B[K].keyNode) && j(J, U, n, v.instance);
              }
          })(c, t, n, s);
          break;
        case 'array':
            ...
            if (Array.isArray(t.items)) {
              for (var s = t.items, c = 0; c < s.length; c++) {
                var u = m(s[c]),
                  f = new y();
                (g = e.items[c])
                  ? (j(g, u, f, a), n.mergePropertyMatch(f))
              ...
              if (e.items.length > s.length)
                if ('object' == typeof t.additionalItems)
                  for (var l = s.length; l < e.items.length; l++) {
                    f = new y();
                    j(e.items[l], t.additionalItems, f, a), n.mergePropertyMatch(f);
                  }
                else
                  !1 === t.additionalItems &&
                    n.problems.push({
              ...
              if (d)
                for (var p = 0, h = e.items; p < h.length; p++) {
                  var g;
                  j((g = h[p]), d, (f = new y()), a), n.mergePropertyMatch(f);
                }
            }
            var x = m(t.contains);
            if (x) {
              e.items.some(function (e) {
                var t = new y();
                return j(e, x, t, v.instance), !t.hasProblems();
              }) ||
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  severity: o.DiagnosticSeverity.Warning,
        ...
        case 'number':
          !(function (e, t, n, a) {
            ...
            var m = p(t.minimum, t.exclusiveMinimum);
            r.isNumber(m) &&
              s <= m &&
              n.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: o.DiagnosticSeverity.Warning,
                message: i('exclusiveMinimumWarning', 'Value is below the exclusive minimum of {0}.', m),
              });
            ...
            var v = h(t.minimum, t.exclusiveMinimum);
            r.isNumber(v) &&
              s < v &&
              n.problems.push({
                location: { offset: e.offset, length: e.length },
            ...
            var y = h(t.maximum, t.exclusiveMaximum);
            r.isNumber(y) &&
              s > y &&
              n.problems.push({
                location: { offset: e.offset, length: e.length },
        ...
        var x = function (e, t) {
          for (var r = [], a = void 0, u = 0, f = e; u < f.length; u++) {
            var l = m(f[u]),
              d = new y(),
              p = s.newSub();
            if ((j(c, l, d, p), d.hasProblems() || r.push(l), a))
              if (t || d.hasProblems() || a.validationResult.hasProblems()) {
                var h = d.compare(a.validationResult);
                h > 0
                  ? (a = { schema: l, validationResult: d, matchingSchemas: p })
                  : 0 === h && (a.matchingSchemas.merge(p), a.validationResult.mergeEnumValues(d));
              } else
        ...
        C &&
          (function (e, t, n) {
            var r = m(e),
              o = new y(),
              i = s.newSub();
            j(c, r, o, i), s.merge(i), o.hasProblems() ? n && S(n) : t && S(t);
          })(C, m(t.then), m(t.else));
        if (Array.isArray(t.enum)) {
          for (var T = b(c), O = !1, k = 0, A = t.enum; k < A.length; k++) {
            var E = A[k];
            if (r.equals(T, E)) {
              O = !0;
              break;
  ...
  (t.JSONDocument = S),
    (t.parse = function (e, t) {
      ...
      function x(e, t, n, r, o) {
        ...
        if ((b(e, t, i, a), n && C(n, !1), r.length + o.length > 0))
      ...
      var T = new d(void 0, 0, 0);
      function O(t, n) {
        var r = new p(t, g.getTokenOffset(), T),
          a = k(r);
        if (!a) {
      ...
      function k(e) {
        if (10 === g.getToken()) {
          ...
          return (t.value = g.getTokenValue()), C(t, !0);
        }
      }
      function A(e) {
        return (
          ...
          (function (e) {
            switch (g.getToken()) {
              case 7:
                return C(new c(e, g.getTokenOffset()), !0);
              case 8:
                return C(new u(e, !0, g.getTokenOffset()), !0);
              case 9:
                return C(new u(e, !1, g.getTokenOffset()), !0);
              default:
                return;
            }
          })(e)
                  ...
                  if (h.node === n && !h.inverted && h.schema) {
                    ...
                    if (void 0 !== c) {
                      ...
                      if (h.schema.properties)
                        (x = h.schema.properties[c]) && ((g = !0), this.addSchemaValueCompletions(x, l, i, a));
          ...
          return this.requestService(e).then(
            ...
            function (t) {
              ...
              return (
                ...
                new u({}, [a('json.schema.nocontent', "Unable to load schema from '{0}': {1}.", h(e), n)])
              );
            }
          );
        }),
        ...
        (e.prototype.getSchemaForResource = function (e, t) {
          ...
          for (var c = Object.create(null), u = [], f = 0, l = this.filePatternAssociations; f < l.length; f++) {
            ...
            if (d.matchesPattern(e))
              for (var h = 0, m = d.getURIs(); h < m.length; h++) {
                var g = m[h];
                c[g] || (u.push(g), (c[g] = !0));
              }
          }
              ...
              h = function (n) {
                ...
                if (n) {
                  if (n.errors.length && t.root) {
                    var d = t.root,
                      h = 'object' === d.type ? d.properties[0] : void 0;
        ...
        return (
          (e.prototype.findDocumentSymbols = function (e, t, o) {
            ...
            for (
              ...
              var T = b[x++];
              C(T.node, T.containerName);
            }
            return S && o && o.onResultLimitExceeded && o.onResultLimitExceeded(f), j;
          }),
          (e.prototype.findDocumentSymbols2 = function (e, t, o) {
            ...
            return C && o && o.onResultLimitExceeded && o.onResultLimitExceeded(f), x;
          }),
  ...
  (function (e) {
    ...
    t.getFoldingRanges = function (e, t) {
      ...
      for (v = 0; v < o.length; v++) {
        var k;
        'number' == typeof (k = i[v]) && (k < C || (k === C && j++ < y)) && O.push(o[v]);
      }
      return O;
    };
  }),
